import{F as d}from"./FullscreenDisplay.b0885eb9.js";import{W as f}from"./WebGlCanvas.e5bcfc98.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.fbb8a992.js";import"./SharedNav.f5ce5cb3.js";import"./VStack.bb8db39c.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
