import{u as A}from"./index.38bb97d1.js";import{B as T,_ as D}from"./VStack.3890b92a.js";import{u as R,_ as ee}from"./ColorSliders.b86b5bf4.js";import{d as V,o as m,f as B,a as l,t as M,F as te,c as h,w as r,m as le,p as H,g as G,b as i,e as w,s as p,a9 as K,aL as oe,u as P,aH as E,q as y}from"./index.8357e48f.js";import{D as ae}from"./Dropdown.af94ca6c.js";import{H as ne,F as se}from"./SharedNav.fef3e396.js";import{F as ie}from"./FullscreenDisplay.2bbe75a1.js";import{I as re}from"./InlineField.cd6eb3ff.js";import{I as z}from"./InlineCheckboxField.218ed933.js";import{L as g}from"./Labeled.e2ddc790.js";import{g as U}from"./useGlsl.e7d88fb3.js";import{s as v}from"./useOption.35cf7fcb.js";import{M as ue}from"./MovableCanvas2d.8c8ba2c5.js";import{I as ce}from"./InlineRangeField.dda8c20a.js";import"./CoordinateCanvas2d.cbc7b8d5.js";import"./WebGlCanvas.a4713718.js";const de=l("h1",null,"Color Sliders",-1),me=V({__name:"ColorSlidersHelp",props:{page:null,note:null},setup(o){return(c,f)=>(m(),B(te,null,[de,l("p",null,M(o.page)+" and many other pages on zSnout share the same set of sliders, so it's good to get used to them. The best way to understand the sliders is to play with them and experiment on various pages."+M(o.note&&` ${o.note}`),1)],64))}}),Z=V({__name:"IconButton",setup(o){return(c,f)=>(m(),h(T,{center:"",style:{width:"2.5em",height:"2.25em"}},{default:r(()=>[le(c.$slots,"default")]),_:3}))}});const fe={},pe=o=>(H("data-v-0298e8c4"),o=o(),G(),o),ve={class:"icon",viewBox:"0 0 485.064 485.064",xmlns:"http://www.w3.org/2000/svg"},he=pe(()=>l("path",{d:`M458.736,181.097H26.334C11.793,181.097,0,192.884,0,207.425v70.215c0,14.541,11.787,26.328,26.334,26.328h432.402\r
  ...
  `,F=p(),q=p(),b=p(),O=p(1);let s;const S=K({get(){return O.value},set(e){O.value=e,s==null||s.setPixelRatio(e)}});return oe(()=>{!F.value||(s=new ue(F.value,{fragmentString:N.replace("{{EQ}}",U(a.value)).replace("{{EQC}}",U(a.value.replace(/m/g,"c"))),saveBounds:!0}),v("resolution",S),F.value.addEventListener("contextmenu",e=>{var t;if(e.preventDefault(),a.value.includes("m")||a.value.includes("t")){const{x:n,y:X}=s.mouseToCoords();a.value=a.value.replace(/m/g,`$(${n}+${X}i)`).replace(/t/g,`@(${s.time})`)}else a.value.includes("$")||a.value.includes("@")?a.value=a.value.replace(/\$\s*\([^)]*\)/g,"m").replace(/@\s*\([^)]*\)/g,"t"):a.value.includes("c")?a.value=a.value.replace(/c/g,"m"):a.value=a.value+"+m";u.value!=="newton"&&!a.value.includes("m")&&(x.value=!0),(t=b.value)==null||t.call(b)}),b.value=()=>setTimeout(()=>s.load(N.replace("{{EQ}}",U(a.value)).replace("{{EQC}}",U(a.value.replace(/m/g,"c"))))),s.on("render",()=>{if(s.setUniform("detail",[c.value]),s.setUniform("limit",_.value),s.setUniformOfInt("theme",[J.value]),s.setUniformOfInt("darkness",[k.value]),s.setUniformOfInt("split",[u.value==="simple"&&a.value.includes("m")||C.value]),s.setUniformOfInt("altColors",[(u.value!=="simple"||a.value.includes("m"))&&I.value]),s.setUniformOfInt("initZ",[u.value==="newton"||a.value.includes("m")||x.value]),s.setUniformOfInt("dualPlot",[a.value.includes("m")&&$.value]),L.setGlsl(s),a.value.includes("m")){const{x:e,y:t}=s.mouseToCoords();s.setUniform("z_offset",e,t)}else if(a.value.includes("$")){const e=a.value.match(/\$\s*\(\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)\s*\+\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)i\s*\)/);if(e){const t=+e[1],n=+e[2];s.setUniform("z_offset",Number.isFinite(t)?t:0,Number.isFinite(n)?n:0)}else s.setUniform("z_offset",0,0)}else s.setUniform("z_offset",0,0)}),q.value=()=>{s.setBounds({xStart:-2,xEnd:2,yStart:-2,yEnd:2})})}),(e,t)=>(m(),h(ie,null,{options:r(()=>[i(Q,{modelValue:P(c),"onUpdate:modelValue":t[0]||(t[0]=n=>E(c)?c.value=n:null),decrement:f,increment:d,label:"Detail Level:"},null,8,["modelValue"]),i(Q,{modelValue:P(_),"onUpdate:modelValue":t[1]||(t[1]=n=>E(_)?_.value=n:null),decrement:j,increment:W,label:"Fractal Size:"},null,8,["modelValue"]),i(g,{label:"Equation:"},{default:r(()=>[i(se,{modelValue:a.value,"onUpdate:modelValue":t[2]||(t[2]=n=>a.value=n)},null,8,["modelValue"]),b.value?(m(),h(T,{key:0,style:{"white-space":"pre"},onClick:b.value},{default:r(()=>[Fe]),_:1},8,["onClick"])):y("",!0)]),_:1}),i(g,{label:"Theme:"},{default:r(()=>[i(ae,{modelValue:u.value,"onUpdate:modelValue":t[3]||(t[3]=n=>u.value=n)},{default:r(()=>[Se,Pe,Ue,qe,Ee,Te]),_:1},8,["modelValue"])]),_:1}),i(ee,{sliders:P(L)},null,8,["sliders"]),i(g,{label:"Darkness Effect?"},{default:r(()=>[i(z,{modelValue:k.value,"onUpdate:modelValue":t[4]||(t[4]=n=>k.value=n)},null,8,["modelValue"])]),_:1}),u.value!=="newton"&&u.value!=="simple"?(m(),h(g,{key:0,label:u.value==="rotation"?"Alternate Split?":u.value==="trig"?"Alternate Trig Functions?":u.value==="exp"?"Invert Exponentials?":"Split Effect?"},{default:r(()=>[i(z,{modelValue:C.value,"onUpdate:modelValue":t[5]||(t[5]=n=>C.value=n)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),u.value==="newton"||u.value==="trig"||u.value==="exp"?(m(),h(g,{key:1,label:u.value==="newton"?"3D Effect?":"Alternate Coloring?"},{default:r(()=>[i(z,{modelValue:I.value,"onUpdate:modelValue":t[6]||(t[6]=n=>I.value=n)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),u.value!=="newton"&&!a.value.includes("m")?(m(),h(g,{key:2,label:"Initialize Z?"},{default:r(()=>[i(z,{modelValue:x.value,"onUpdate:modelValue":t[7]||(t[7]=n=>x.value=n)},null,8,["modelValue"])]),_:1})):y("",!0),a.value.includes("m")?(m(),h(g,{key:3,label:"Dual Coloring?"},{default:r(()=>[i(z,{modelValue:$.value,"onUpdate:modelValue":t[8]||(t[8]=n=>$.value=n)},null,8,["modelValue"])]),_:1})):y("",!0),i(g,{label:"Resolution:"},{default:r(()=>[i(ce,{modelValue:P(S),"onUpdate:modelValue":t[9]||(t[9]=n=>E(S)?S.value=n:null),min:.1,max:1,step:"any"},null,8,["modelValue","min"])]),_:1})]),buttons:r(()=>[q.value?(m(),h(T,{key:0,onClick:q.value},{default:r(()=>[Me]),_:1},8,["onClick"])):y("",!0)]),help:r(()=>[De,Be,Le,Ne,Oe,Ae,Re,Ke,Ze,Qe,He,Ge,je,We,Ye,i(me,{page:"Fractal Explorer",note:`Note that
    "Grayscale" and "Overcoloring" only have effects in themes with gray colors
    ("Gradient", "Trigonometric", and "Exponential").`}),Je,Xe,et]),default:r(()=>[l("canvas",{ref_key:"canvas",ref:F},null,512)]),_:1}))}});export{_t as default};
