import{u as $,s as v,p as k,d as L,c as O,q as F,i as H}from"./main.200onzgm.js";import{D as q}from"./DocumentDisplay.6d0yf2eg.js";import{I as m}from"./InlineButton.12vhnjwt.js";import{L as M}from"./LargeTitle.364aftl6.js";import{_ as V}from"./BookmarkIcon.46krkaf8.js";import{S as N}from"./SearchableCardGrid.7foww6wh.js";import{V as W}from"./VStack.3evi6szx.js";import{d as _}from"./useDateOf.chuxq7z2.js";import{l as Y,r as x,x as n,y as r,F as l,D as s,G as p,a9 as c,I as u,u as a,H as i,ah as S,C as A,E as w,B as G,ac as J,ad as P,ae as R}from"./runtime-core.esm-bundler.47vl3tei.js";import{a as E}from"./_plugin-vue_export-helper.4yxwi37t.js";import"./Navigation.vue_vue_type_script_setup_true_lang.4wr1p5fg.js";import"./Logo.vue_vue_type_script_setup_true_lang.2nyidlx8.js";import"./LogoLight.3fmf1259.js";import"./SharedNav.4z4l3m5g.js";import"./Title.4eiq6n5a.js";import"./Field.5c7fkv56.js";import"./CardGrid.1kdxvvm0.js";const b=[{path:"/blog/divisibility-rules.md",frontmatter:{excerpt:`
...
in!`,author:"Zachary Sakowitz",category:"code",date:16686432e5}}],j=f=>(P("data-v-168f1764"),f=f(),R(),f),U={key:0,class:"text-color"},Q={key:1,class:"text-color"},X={class:"title"},K={key:0,class:"intro"},tt={key:1,class:"intro"},et={key:2,class:"spacer"},at={class:"text-color"},ot=j(()=>c("p",null,[c("strong",null,"Filter By:")],-1)),nt=Y({__name:"index",setup(f){const z=b.map(o=>o.frontmatter.category).filter(o=>!!o).filter((o,e,d)=>d.indexOf(o)===e);b.sort((o,e)=>{if(!o.frontmatter.date)return 1;if(!e.frontmatter.date)return-1;const d=new Date(o.frontmatter.date);return new Date(e.frontmatter.date).valueOf()-d.valueOf()});const h=x(""),I=$("(min-width: 1080px)"),y=x(!1),Z={camp:0,code:4,language:2,math:1,meta:5,saurs:3};function C(o){return Z[o||""]}const B=["#990000","#996300","#999900","#009900","#000099","#990099"],T=["#ff6666","#ffc966","#f0f060","#66ff66","#8888ff","#ff66ff"];function D(o,e){const d=75*Math.random()+12.5,t=(o?B:T)[C(e)];return`background: ${`linear-gradient(to right, transparent, transparent ${d}%, ${t})`}`}return(o,e)=>{const d=J("RouterLink");return n(),r(p,null,[l(V,{open:y.value,"onUpdate:open":e[0]||(e[0]=t=>y.value=t)},null,8,["open"]),l(q,{small:""},{help:s(()=>[c("p",null," You can "+u(a(I)?"use the sidebar to filter the pages.":"use the table of contents to filter the pages."),1)]),aside:s(()=>[ot,c("nav",null,[c("ul",null,[c("li",null,[l(m,{onClick:e[4]||(e[4]=t=>h.value="")},{default:s(()=>[i("Reset Filter")]),_:1})]),(n(!0),r(p,null,S(a(z),t=>(n(),r("li",{key:t},[l(m,{active:h.value===t,onClick:g=>h.value===t?h.value="":h.value=t},{default:s(()=>[i(u(t[0].toUpperCase()+t.slice(1)),1)]),_:2},1032,["active","onClick"])]))),128))])])]),default:s(()=>[l(M,null,{default:s(()=>[i("Blog Articles")]),_:1}),a(v)?(n(),r("p",U,[i(" You "+u(a(k)?"are currently receiving":"will not receive")+" notifications for updates to the zSnout blog. ",1),a(L)?(n(),r(p,{key:0},[i(" Click "),l(m,{onClick:e[1]||(e[1]=t=>a(O).emit("blog:update:will-notify",a(v),!a(k)))},{default:s(()=>[i(" here ")]),_:1}),i(" to opt-"+u(a(k)?"out of":"in to")+" notifications. ",1)],64)):(n(),r(p,{key:1},[i(" You cannot change notification settings when offline. ")],64))])):(n(),r("p",Q,[l(m,{onClick:e[2]||(e[2]=t=>y.value=!0)},{default:s(()=>[i("Log in")]),_:1}),i(" to a zSnout account or "),l(m,{onClick:e[3]||(e[3]=t=>y.value=!0)},{default:s(()=>[i("sign up")]),_:1}),i(" to receive notification for new blog posts. ")])),l(N,{sizes:["list"]},{default:s(()=>[(n(!0),r(p,null,S(a(b),t=>{var g;return n(),r(p,{key:t.path},[!h.value||(g=t.frontmatter.category)!=null&&g.includes(h.value)?(n(),A(W,{key:0,class:"card",space:0,style:G(D(a(H),t.frontmatter.category)),"data-keywords":`${t.frontmatter.author!=="Zachary Sakowitz"?t.frontmatter.author:""} ${t.frontmatter.keywords||""} ${a(_)(t.frontmatter.date)}`},{default:s(()=>[l(d,{class:"no-link",to:t.path.slice(0,-3)},{default:s(()=>[c("p",X,u(a(F)(t.path.slice(6,-3))),1)]),_:2},1032,["to"]),t.frontmatter.author&&t.frontmatter.author!=="Zachary Sakowitz"?(n(),r("p",K," By "+u(t.frontmatter.author),1)):w("",!0),t.frontmatter.date?(n(),r("p",tt," Published on "+u(a(_)(t.frontmatter.date)),1)):w("",!0),t.frontmatter.excerpt?(n(),r("p",et)):w("",!0),c("p",at,u(t.frontmatter.excerpt),1)]),_:2},1032,["style","data-keywords"])):w("",!0)],64)}),128))]),_:1})]),_:1})],64)}}});const _t=E(nt,[["__scopeId","data-v-168f1764"]]);export{_t as default};
