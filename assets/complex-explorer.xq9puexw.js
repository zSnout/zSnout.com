import{d as q,q as l,P as F,L as P,Y as T,C as V,o as x,c as d,w as n,e as i,b as h,j as z,u as S,a as y,_ as D}from"./index.49e43vj6.js";import{B as w}from"./VStack.6d7g92uw.js";import{u as C,_ as L}from"./ColorSliders.vue_vue_type_script_setup_true_lang.5x2ux4ix.js";import{F as N}from"./Field.2ydu2jt8.js";import{F as R}from"./FullscreenDisplay.421pqk6v.js";import{H as $}from"./BookmarkIcon.3wmuqdow.js";import{L as A}from"./Labeled.29mn7ohi.js";import{g as H}from"./useGlsl.65muxzpz.js";import{s as I}from"./useOption.ujvp9hcq.js";import{M as Q}from"./MovableCanvas2d.3k2tk05z.js";import"./InlineRangeField.4poaov81.js";import"./LogoLight.539ztpd2.js";import"./SharedNav.238jku1n.js";import"./CoordinateCanvas2d.ui5o1n16.js";import"./WebGlCanvas.1rb17qef.js";const U=["value"],X=q({__name:"complex-explorer",setup(j){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:_}=F(r);P(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function k(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/_.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/_.value)),t.value=!1}}const u=l("z^2");I("equation",u);const b=C(),M=`
  uniform float time;
