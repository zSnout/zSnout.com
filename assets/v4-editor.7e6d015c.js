import{u as j,E as C}from"./useLocationHash.acdeba0a.js";import{d as f,_ as S}from"./index.58539d0e.js";import{u as V,C as E}from"./Console.96eef5cd.js";import{d as w,B as O,aq as B,M as U,o as h,c as b,u as n,x as g,w as W,b as y}from"./index.b28acfcf.js";import"./DocumentDisplay.9b20b119.js";import"./BookmarkIcon.90b7aed7.js";import"./AceEditor.3a2ae036.js";import"./_commonjsHelpers.294d03c4.js";import"./__vite-browser-external.2d3e1c2d.js";import"./Dropdown.4fe2f8dc.js";import"./Labeled.e5e1f199.js";const $=w({__name:"Viewer4",props:{code:null},setup(p){const s=p,{console:u,field:i,messages:l,onKey:x,onSelect:_,onSubmit:k,placeholder:m}=V(),v=Object.getPrototypeOf(async function(){}).constructor;function c(){u.clear(),m.value="",Object.assign(window,u),Object.assign(window,{print:u.log,jsx(r,e,...t){if(typeof r=="string"){let a=document.createElement(r);for(let o in e)if(o==="style")for(let d in e.style)a.style[d]=e.style[d];else o.startsWith("data")?a.dataset[o.slice(4)]=e[o]:o.startsWith("on")?a.addEventListener(o.slice(2,3).toUpperCase()+o.slice(3),e[o]):a[o]=e[o];for(let o of t.flat(1/0))o instanceof Node||typeof o=="string"?a.append(o):a.append(""+o);return a}try{return new r(t.length?{...e,children:t}:e)}catch{return r(t.length?{...e,children:t}:e)}}}),new v(f.transpile(f.compile(s.code),{jsx:"jsx",target:99}))()}return c(),O(U(s,"code"),B(c,1e3)),(r,e)=>(h(),b(E,{field:n(i),"onUpdate:field":e[0]||(e[0]=t=>g(i)?i.value=t:null),messages:n(l),"onUpdate:messages":e[1]||(e[1]=t=>g(l)?l.value=t:null),placeholder:n(m),onKey:n(x),onSelect:n(_),onSubmit:n(k)},null,8,["field","messages","placeholder","onKey","onSelect","onSubmit"]))}}),G=w({__name:"v4-editor",setup(p){const s=j(`money = 500
eggs = 0
...
await market()`);return(u,i)=>(h(),b(C,null,{default:W(()=>[y(S,{modelValue:n(s),"onUpdate:modelValue":i[0]||(i[0]=l=>g(s)?s.value=l:null),round:""},null,8,["modelValue"]),y($,{code:n(s),round:""},null,8,["code"])]),_:1}))}});export{G as default};
