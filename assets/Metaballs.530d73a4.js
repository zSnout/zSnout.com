import{F as d}from"./FullscreenDisplay.f6975a23.js";import{W as f}from"./WebGlCanvas.1d46ee26.js";import{d as x,s as y,aG as m,o as g,c as p,w as u,a as h}from"./index.d85e9aa1.js";import"./SharedNav.4e72febd.js";import"./VStack.064f6e3e.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
