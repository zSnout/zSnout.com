import{F as d}from"./FullscreenDisplay.753cc664.js";import{W as f}from"./WebGlCanvas.50702274.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.b536fd91.js";import"./SharedNav.2c352519.js";import"./VStack.258b179b.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
