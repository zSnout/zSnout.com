import{F as d}from"./FullscreenDisplay.7ce53f2a.js";import{W as f}from"./WebGlCanvas.c5ef6710.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.f7adb33e.js";import"./SharedNav.cf80e2c2.js";import"./VStack.c8a162cb.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
