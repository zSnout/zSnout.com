import{F as i}from"./FullscreenDisplay.81fca273.js";import{W as f}from"./WebGlCanvas.effdf53a.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.a25085ae.js";import"./BookmarkIcon.41f4f1ab.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
