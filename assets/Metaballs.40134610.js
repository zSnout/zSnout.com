import{F as d}from"./FullscreenDisplay.17bb050f.js";import{W as f}from"./WebGlCanvas.98cacfd1.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.23592886.js";import"./BookmarkIcon.8da08d84.js";import"./VStack.23a9f6eb.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
