import{F as d}from"./FullscreenDisplay.2bbe75a1.js";import{W as f}from"./WebGlCanvas.a4713718.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.8357e48f.js";import"./SharedNav.fef3e396.js";import"./VStack.3890b92a.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
