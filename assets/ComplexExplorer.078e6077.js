import{d as F,s as l,S,aG as T,aM as V,j as q,o as x,c as d,w as n,b as i,m as h,u as P,a as _,e as w}from"./index.16b8f1ff.js";import{_ as D,B as C}from"./VStack.e3b08f22.js";import{u as z,_ as N}from"./ColorSliders.49a27a00.js";import{F as R,H as L}from"./SharedNav.cab40430.js";import{F as $}from"./FullscreenDisplay.76b26a61.js";import{L as A}from"./Labeled.2bd3b830.js";import{g as G}from"./useGlsl.9495b1d0.js";import{s as H}from"./useOption.95c28a45.js";import{M as I}from"./MovableCanvas2d.51aa115b.js";import"./InlineRangeField.0ea488dc.js";import"./CoordinateCanvas2d.3646c561.js";import"./WebGlCanvas.cc227325.js";const Q=w(" Apply "),U=w(" Reset Position "),X=["value"],j=F({__name:"ComplexExplorer",setup(O){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:y}=S(r);T(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function k(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const u=l("z^2");H("equation",u);const g=z(),M=`
  uniform float time;
