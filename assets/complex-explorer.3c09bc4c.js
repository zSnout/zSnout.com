import{d as M,m as l,N as T,aF as V,aL as q,av as P,o as x,c as d,w as n,b as i,j as h,u as S,a as _,e as k}from"./index.9d51cee5.js";import{B as z}from"./VStack.1e10fe03.js";import{u as w,_ as N}from"./ColorSliders.d520372a.js";import{F as D,H as L}from"./SharedNav.83eaab56.js";import{F as R}from"./FullscreenDisplay.a8ca1458.js";import{L as $}from"./Labeled.749825ff.js";import{g as A}from"./useGlsl.9495b1d0.js";import{s as H}from"./useOption.db6d066d.js";import{M as I}from"./MovableCanvas2d.a77b6437.js";import{_ as Q}from"./plugin-vue_export-helper.21dcd24c.js";import"./InlineRangeField.0b156467.js";import"./LogoLight.117571b3.js";import"./CoordinateCanvas2d.280dbecf.js";import"./WebGlCanvas.5bbd9670.js";const U=k(" Apply "),X=k(" Reset Position "),j=["value"],G=M({__name:"complex-explorer",setup(O){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:y}=T(r);V(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function C(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const u=l("z^2");H("equation",u);const g=w(),F=`
  uniform float time;
