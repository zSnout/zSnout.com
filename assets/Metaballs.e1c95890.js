import{F as d}from"./FullscreenDisplay.a4360b3b.js";import{W as f}from"./WebGlCanvas.8976ae90.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.ea2ab528.js";import"./BookmarkIcon.6af38a46.js";import"./VStack.9479ad49.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
