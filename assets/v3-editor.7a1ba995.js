import{u as M,E as b}from"./useLocationHash.dafcecd8.js";import{_ as A}from"./Editor3.a9c584d5.js";import{u as P}from"./useTypewrite.705f091f.js";import{u as F,C as N}from"./Console.81e46593.js";import{s as k}from"./compiler3.e1bd1ac4.js";import{d,D as V,aj as R,M as S,o as $,c as x,u as r,x as p,w as j,b as y}from"./index.f235fda5.js";import"./DocumentDisplay.76f14a28.js";import"./BookmarkIcon.8ac6d5c6.js";import"./AceEditor.992471bc.js";import"./Dropdown.2f9b8a0b.js";import"./Labeled.e5ea23b1.js";var T=`const post = self.postMessage;
...
def @eggsfn
  ...
  @menu "Are you sure you want to buy them?"
    ...
    @option "No"
      "Okay, let's go back to the store."`);return(i,m)=>($(),x(b,null,{default:j(()=>[y(A,{modelValue:r(a),"onUpdate:modelValue":m[0]||(m[0]=u=>p(a)?a.value=u:null),round:""},null,8,["modelValue"]),y(C,{code:r(a)},null,8,["code"])]),_:1}))}});export{I as default};
