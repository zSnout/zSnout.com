import{F as d}from"./FullscreenDisplay.932e0ad7.js";import{W as f}from"./WebGlCanvas.70752987.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.83c4a656.js";import"./SharedNav.e6a4076c.js";import"./VStack.2a9a794c.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
