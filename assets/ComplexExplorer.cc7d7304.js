import{d as M,k as l,P,aF as V,aL as q,j as S,o as d,c as x,w as s,b as i,m as C,u as T,a as _,e as k}from"./index.6fd38de8.js";import{_ as D,B as h}from"./VStack.0099a460.js";import{u as z,_ as L}from"./ColorSliders.2bf6f478.js";import{F as N,H as R}from"./BookmarkIcon.8dca6511.js";import{F as $}from"./FullscreenDisplay.de0ed3d0.js";import{L as A}from"./Labeled.d8315c55.js";import{g as H}from"./useGlsl.0c9126ed.js";import{s as I}from"./useOption.09504db0.js";import{M as Q}from"./MovableCanvas2d.24ccf8f2.js";import"./InlineRangeField.41b559c1.js";import"./CoordinateCanvas2d.54a74f40.js";import"./WebGlCanvas.55c1ba96.js";const U=k(" Apply "),X=k(" Reset Position "),j=["value"],G=M({__name:"ComplexExplorer",setup(O){const e=l(1),t=l(!1),c=l(!1),u=l(!1),r=l(),{width:y}=P(r);V(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function E(){e.value=1,t.value=!0,c.value=!0}function w(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(u.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(u.value=!1),u.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!u.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const n=l("z^2");I("equation",n);const b=z(),F=`
  uniform float time;
