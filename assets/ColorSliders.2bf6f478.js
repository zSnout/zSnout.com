import{d as b,o as g,f as z,b as r,w as t,u as v,aH as n,F as w,k as a,aF as V}from"./index.6fd38de8.js";import{s as c}from"./useOption.09504db0.js";import{I as i}from"./InlineRangeField.41b559c1.js";import{L as m}from"./Labeled.d8315c55.js";function _(){const o=a(0);c("colorOffset",o);const x=a(0);c("grayscale",x);const e=a(1);c("repetition",e);const u=a(0);c("noise",u);const f=a(0);c("separation",f);const d=a(1);c("spectrum",d);const p=a(0);c("overcolor",p);const h=a(Math.random()*1e4);return V(()=>h.value+=.01),{colorOffset:o,grayscale:x,noiseLevel:u,overcolor:p,repetition:e,separation:f,spectrum:d,time:h,setGlsl:U}}(o=>{function x(e){return`
