import{F as d}from"./FullscreenDisplay.a8c334ca.js";import{W as f}from"./WebGlCanvas.e0c96e5c.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.b9970ef9.js";import"./BookmarkIcon.261f9e8c.js";import"./Button.c3a7b0cc.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
