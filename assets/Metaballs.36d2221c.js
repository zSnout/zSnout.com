import{F as i}from"./FullscreenDisplay.9e1a1424.js";import{W as f}from"./WebGlCanvas.f8c7430b.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.ca3f168f.js";import"./BookmarkIcon.592ee3d3.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
