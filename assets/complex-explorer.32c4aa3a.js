import{d as S,s as l,S as F,aS as T,aG as V,j as q,o as x,c as d,w as n,b as i,m as h,u as P,a as _,e as k}from"./index.d85e9aa1.js";import{_ as D,B as z}from"./VStack.064f6e3e.js";import{u as w,_ as N}from"./ColorSliders.be60aa75.js";import{F as R,H as L}from"./SharedNav.4e72febd.js";import{F as $}from"./FullscreenDisplay.f6975a23.js";import{L as A}from"./Labeled.32d2cb50.js";import{g as G}from"./useGlsl.9495b1d0.js";import{s as H}from"./useOption.af012118.js";import{M as I}from"./MovableCanvas2d.2fea9177.js";import"./InlineRangeField.ec59f2e0.js";import"./CoordinateCanvas2d.91c11cde.js";import"./WebGlCanvas.1d46ee26.js";const Q=k(" Apply "),U=k(" Reset Position "),X=["value"],j=S({__name:"complex-explorer",setup(O){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:y}=F(r);T(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function C(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const u=l("z^2");H("equation",u);const g=w(),M=`
  uniform float time;
