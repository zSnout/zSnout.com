import{d as q,q as l,U as F,aK as T,aG as V,aA as P,o as x,c as d,w as n,b as i,k as h,u as S,a as _,e as w}from"./index.5eygmsavjzc0.js";import{B as z}from"./Button.32h7782uxra0.js";import{u as k,_ as D}from"./ColorSliders.12r88cc6jki8.js";import{F as N,H as R}from"./SharedNav.3q0ndchopua0.js";import{F as A}from"./FullscreenDisplay.2pmkxxoua4y0.js";import{L}from"./Labeled.x87dtudfywg0.js";import{g as U}from"./useGlsl.65muxzpzqr80.js";import{s as $}from"./useOption.ujvp9hcq9ds0.js";import{M as G}from"./MovableCanvas2d.3k2tk05z89m0.js";import{_ as H}from"./plugin-vue_export-helper.62h235na3u80.js";import"./InlineRangeField.4y4yst1nfm00.js";import"./LogoLight.11xzt69hf600.js";import"./CoordinateCanvas2d.ui5o1n16sxs0.js";import"./WebGlCanvas.1rb17qef21sw.js";const I=w(" Apply "),Q=w(" Reset Position "),X=["value"],K=q({__name:"complex-explorer",setup(O){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:y}=F(r);T(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function C(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const u=l("z^2");$("equation",u);const g=k(),M=`
  uniform float time;
