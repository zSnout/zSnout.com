import{F as d}from"./FullscreenDisplay.76b26a61.js";import{W as f}from"./WebGlCanvas.cc227325.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.16b8f1ff.js";import"./SharedNav.cab40430.js";import"./VStack.e3b08f22.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
