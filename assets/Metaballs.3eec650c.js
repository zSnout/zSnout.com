import{F as d}from"./FullscreenDisplay.96367436.js";import{W as f}from"./WebGlCanvas.4130eb45.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.5ecff434.js";import"./SharedNav.04ff8d8d.js";import"./VStack.0cf8ef58.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
