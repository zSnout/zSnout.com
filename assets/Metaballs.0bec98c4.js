import{F as i}from"./FullscreenDisplay.a8f4099e.js";import{W as f}from"./WebGlCanvas.c921704f.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.049f040d.js";import"./BookmarkIcon.c706e471.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
