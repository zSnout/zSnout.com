import{F as d}from"./FullscreenDisplay.f1c2ec96.js";import{W as f}from"./WebGlCanvas.ad221145.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.c95663db.js";import"./BookmarkIcon.73029374.js";import"./VStack.49536e5f.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
