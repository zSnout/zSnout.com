import{F as d}from"./FullscreenDisplay.eafb7b2f.js";import{W as f}from"./WebGlCanvas.3e712317.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.103f168a.js";import"./SharedNav.8af10a76.js";import"./VStack.1c4fdd7b.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
