import{F as d}from"./FullscreenDisplay.7003d5a1.js";import{W as f}from"./WebGlCanvas.ed6f0748.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.08441792.js";import"./SharedNav.b331d2ea.js";import"./VStack.2f484e9a.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
