import{F as d}from"./FullscreenDisplay.e6d20e7e.js";import{W as f}from"./WebGlCanvas.881b9f37.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.8951f436.js";import"./BookmarkIcon.c98cc4e5.js";import"./VStack.599fd702.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
