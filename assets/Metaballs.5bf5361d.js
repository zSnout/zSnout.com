import{F as d}from"./FullscreenDisplay.69bcbaaa.js";import{W as f}from"./WebGlCanvas.c2d21cf4.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.b44de49b.js";import"./SharedNav.8d8fd594.js";import"./VStack.37d2f7f6.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
