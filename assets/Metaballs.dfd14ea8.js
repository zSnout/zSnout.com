import{F as i}from"./FullscreenDisplay.7b04f428.js";import{W as f}from"./WebGlCanvas.0b46a99d.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.3fd24dee.js";import"./BookmarkIcon.2ba3923d.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
