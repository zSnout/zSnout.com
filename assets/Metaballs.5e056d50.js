import{F as d}from"./FullscreenDisplay.7eaa98f9.js";import{W as f}from"./WebGlCanvas.32d83ee7.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.7141cb12.js";import"./BookmarkIcon.e2141b75.js";import"./VStack.9632794c.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
