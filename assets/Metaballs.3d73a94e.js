import{F as i}from"./FullscreenDisplay.26e96a2b.js";import{W as f}from"./WebGlCanvas.9d9b40d0.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.5bcce4fc.js";import"./BookmarkIcon.929a48f2.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
