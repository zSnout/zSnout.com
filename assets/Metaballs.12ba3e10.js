import{F as i}from"./FullscreenDisplay.bb08519f.js";import{W as f}from"./WebGlCanvas.59460c79.js";import{d as x,k as y,B as m,c as g,w as p,o as u,a as h}from"./index.09ff9e18.js";import"./Modal.9c2abee5.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
