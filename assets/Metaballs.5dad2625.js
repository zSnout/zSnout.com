import{F as d}from"./FullscreenDisplay.f8e66f59.js";import{W as f}from"./WebGlCanvas.a8ac6cbf.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.0a8dc34f.js";import"./BookmarkIcon.55749bc2.js";import"./VStack.a8f4160e.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
