import{d as L,q as v,f as T,o as n,h as r,e as l,w as s,F as p,a as c,t as u,u as o,b as i,E as _,s as S,a5 as w,K as O,H as F,c as q,a6 as M,i as k,A as V,y as A,k as H,p as N,l as W,_ as Y}from"./index.e8mnt7cd.js";import{D as J}from"./DocumentDisplay.633jhlro.js";import{I as m}from"./InlineButton.197m3pe8.js";import{L as R}from"./LargeTitle.1lwzjamx.js";import{_ as E}from"./BookmarkIcon.1thszj4g.js";import{S as G}from"./SearchableCardGrid.4qzy9rf8.js";import{V as U}from"./VStack.xad5wxbj.js";import{d as x}from"./useDateOf.86m05b59.js";import"./Navigation.vue_vue_type_script_setup_true_lang.4huvb0n5.js";import"./Logo.vue_vue_type_script_setup_true_lang.5f5g8ttt.js";import"./LogoLight.539ztpd2.js";import"./SharedNav.28xyli12.js";import"./Title.3fz2k97a.js";import"./Field.2ydu2jt8.js";import"./CardGrid.2ocy45od.js";const b=[{path:"/blog/divisibility-rules.md",frontmatter:{excerpt:`
...
in!`,author:"Zachary Sakowitz",category:"code",date:16686432e5}}],j=f=>(N("data-v-168f1764"),f=f(),W(),f),K={key:0,class:"text-color"},P={key:1,class:"text-color"},Q={class:"title"},X={key:0,class:"intro"},tt={key:1,class:"intro"},et={key:2,class:"spacer"},ot={class:"text-color"},at=j(()=>c("p",null,[c("strong",null,"Filter By:")],-1)),nt=L({__name:"index",setup(f){const z=b.map(a=>a.frontmatter.category).filter(a=>!!a).filter((a,e,d)=>d.indexOf(a)===e);b.sort((a,e)=>{if(!a.frontmatter.date)return 1;if(!e.frontmatter.date)return-1;const d=new Date(a.frontmatter.date);return new Date(e.frontmatter.date).valueOf()-d.valueOf()});const h=v(""),I=T("(min-width: 1080px)"),y=v(!1),Z={camp:0,code:4,language:2,math:1,meta:5,saurs:3};function C(a){return Z[a||""]}const B=["#990000","#996300","#999900","#009900","#000099","#990099"],$=["#ff6666","#ffc966","#f0f060","#66ff66","#8888ff","#ff66ff"];function D(a,e){const d=75*Math.random()+12.5,t=(a?B:$)[C(e)];return`background: ${`linear-gradient(to right, transparent, transparent ${d}%, ${t})`}`}return(a,e)=>{const d=H("RouterLink");return n(),r(p,null,[l(E,{open:y.value,"onUpdate:open":e[0]||(e[0]=t=>y.value=t)},null,8,["open"]),l(J,{small:""},{help:s(()=>[c("p",null," You can "+u(o(I)?"use the sidebar to filter the pages.":"use the table of contents to filter the pages."),1)]),aside:s(()=>[at,c("nav",null,[c("ul",null,[c("li",null,[l(m,{onClick:e[4]||(e[4]=t=>h.value="")},{default:s(()=>[i("Reset Filter")]),_:1})]),(n(!0),r(p,null,_(o(z),t=>(n(),r("li",{key:t},[l(m,{active:h.value===t,onClick:g=>h.value===t?h.value="":h.value=t},{default:s(()=>[i(u(t[0].toUpperCase()+t.slice(1)),1)]),_:2},1032,["active","onClick"])]))),128))])])]),default:s(()=>[l(R,null,{default:s(()=>[i("Blog Articles")]),_:1}),o(S)?(n(),r("p",K,[i(" You "+u(o(w)?"are currently receiving":"will not receive")+" notifications for updates to the zSnout blog. ",1),o(O)?(n(),r(p,{key:0},[i(" Click "),l(m,{onClick:e[1]||(e[1]=t=>o(F).emit("blog:update:will-notify",o(S),!o(w)))},{default:s(()=>[i(" here ")]),_:1}),i(" to opt-"+u(o(w)?"out of":"in to")+" notifications. ",1)],64)):(n(),r(p,{key:1},[i(" You cannot change notification settings when offline. ")],64))])):(n(),r("p",P,[l(m,{onClick:e[2]||(e[2]=t=>y.value=!0)},{default:s(()=>[i("Log in")]),_:1}),i(" to a zSnout account or "),l(m,{onClick:e[3]||(e[3]=t=>y.value=!0)},{default:s(()=>[i("sign up")]),_:1}),i(" to receive notification for new blog posts. ")])),l(G,{sizes:["list"]},{default:s(()=>[(n(!0),r(p,null,_(o(b),t=>{var g;return n(),r(p,{key:t.path},[!h.value||((g=t.frontmatter.category)==null?void 0:g.includes(h.value))?(n(),q(U,{key:0,class:"card",space:0,style:V(D(o(A),t.frontmatter.category)),"data-keywords":`${t.frontmatter.author!=="Zachary Sakowitz"?t.frontmatter.author:""} ${t.frontmatter.keywords||""} ${o(x)(t.frontmatter.date)}`},{default:s(()=>[l(d,{class:"no-link",to:t.path.slice(0,-3)},{default:s(()=>[c("p",Q,u(o(M)(t.path.slice(6,-3))),1)]),_:2},1032,["to"]),t.frontmatter.author&&t.frontmatter.author!=="Zachary Sakowitz"?(n(),r("p",X," By "+u(t.frontmatter.author),1)):k("",!0),t.frontmatter.date?(n(),r("p",tt," Published on "+u(o(x)(t.frontmatter.date)),1)):k("",!0),t.frontmatter.excerpt?(n(),r("p",et)):k("",!0),c("p",ot,u(t.frontmatter.excerpt),1)]),_:2},1032,["style","data-keywords"])):k("",!0)],64)}),128))]),_:1})]),_:1})],64)}}});const bt=Y(nt,[["__scopeId","data-v-168f1764"]]);export{bt as default};
