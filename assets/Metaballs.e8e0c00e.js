import{F as i}from"./FullscreenDisplay.74a577c5.js";import{W as f}from"./WebGlCanvas.8c14d3ec.js";import{d as x,k as y,B as m,c as g,w as p,o as u,a as h}from"./index.4d3896d1.js";import"./Modal.82f47c6d.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
