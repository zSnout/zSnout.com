import{d as b,o as g,f as z,b as r,w as t,u as v,x as n,F as w,k as a,_ as V}from"./index.e8a5d947.js";import{s as c}from"./useOption.bfd3ca90.js";import{I as i}from"./InlineRangeField.ed663bcc.js";import{L as m}from"./Labeled.f8d26032.js";function _(){const o=a(0);c("colorOffset",o);const x=a(0);c("grayscale",x);const e=a(1);c("repetition",e);const u=a(0);c("noise",u);const f=a(0);c("separation",f);const d=a(1);c("spectrum",d);const p=a(0);c("overcolor",p);const h=a(Math.random()*1e4);return V(()=>h.value+=.01),{colorOffset:o,grayscale:x,noiseLevel:u,overcolor:p,repetition:e,separation:f,spectrum:d,time:h,setGlsl:U}}(o=>{function x(e){return`
