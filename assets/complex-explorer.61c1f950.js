import{d as F,m as l,S,aG as T,aM as V,az as q,o as x,c as d,w as n,b as i,k as h,u as P,a as _,e as w}from"./index.7cf42d56.js";import{B as z}from"./Button.36184581.js";import{u as k,_ as D}from"./ColorSliders.c8d5d215.js";import{F as N,H as R}from"./SharedNav.089cb081.js";import{F as L}from"./FullscreenDisplay.1b26e18e.js";import{L as $}from"./Labeled.ee08ebc3.js";import{g as A}from"./useGlsl.9495b1d0.js";import{s as G}from"./useOption.531d5967.js";import{M as H}from"./MovableCanvas2d.175734fe.js";import{_ as I}from"./plugin-vue_export-helper.21dcd24c.js";import"./InlineRangeField.4304fa70.js";import"./LogoLight.382d1bf4.js";import"./CoordinateCanvas2d.fd9684ed.js";import"./WebGlCanvas.34042cbc.js";const Q=w(" Apply "),U=w(" Reset Position "),X=["value"],O=F({__name:"complex-explorer",setup(j){const e=l(1),t=l(!1),c=l(!1),s=l(!1),r=l(),{width:y}=S(r);T(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function C(){e.value=1,t.value=!0,c.value=!0}function E(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(s.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(s.value=!1),s.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!s.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const u=l("z^2");G("equation",u);const g=k(),M=`
  uniform float time;
