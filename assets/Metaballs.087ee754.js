import{F as d}from"./FullscreenDisplay.940be9dd.js";import{W as f}from"./WebGlCanvas.35f6a120.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.28689de5.js";import"./SharedNav.4f31c517.js";import"./VStack.8bd5b689.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
