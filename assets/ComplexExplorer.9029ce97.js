import{d as F,k as l,$ as V,a0 as q,I as P,j as S,c as d,w as s,o as x,b as i,m as C,u as T,a as _,e as k}from"./index.ca3f168f.js";import{_ as D,F as N,b as h,H as R}from"./BookmarkIcon.592ee3d3.js";import{u as z,_ as $}from"./ColorSliders.f8b8c18e.js";import{F as I}from"./FullscreenDisplay.9e1a1424.js";import{L}from"./Labeled.df2ca1b5.js";import{g as A}from"./useGlsl.b990d597.js";import{s as H}from"./useOption.33b6e1f0.js";import{M as Q}from"./MovableCanvas2d.eda4a040.js";import"./InlineRangeField.c0a33169.js";import"./CoordinateCanvas2d.1225017d.js";import"./WebGlCanvas.f8c7430b.js";const U=k(" Apply "),X=k(" Reset Position "),j=["value"],G=F({__name:"ComplexExplorer",setup(O){const e=l(1),t=l(!1),c=l(!1),u=l(!1),r=l(),{width:y}=V(r);q(()=>{!t.value||(e.value>1?(t.value=!1,e.value=1):e.value<0?(c.value=!1,e.value=0):c.value?e.value=(200*e.value-10)/200:t.value&&(e.value=(200*e.value+1)/200))});function E(){e.value=1,t.value=!0,c.value=!0}function w(){t.value?t.value=!1:t.value=!0}function v(a){var o;a.preventDefault(),a.type==="pointerdown"?(u.value=!0,(o=r.value)==null||o.setPointerCapture(a.pointerId)):a.type==="pointerup"&&(u.value=!1),u.value&&(e.value=Math.min(1,Math.max(0,a.offsetX/y.value)),t.value=!1)}function B(a){if(!!u.value&&(a.preventDefault(),r.value)){const o=a.changedTouches[0].pageX-r.value.getBoundingClientRect().x;e.value=Math.min(1,Math.max(0,o/y.value)),t.value=!1}}const n=l("z^2");H("equation",n);const b=z(),M=`
  uniform float time;
  ...
  `,f=l(),p=l(),m=l();return P(()=>{if(!f.value)return;const a=new Q(f.value,{fragmentString:M.replace("{{EQ}}",A(n.value)),saveBounds:!0});m.value=()=>setTimeout(()=>location.reload()),a.on("render",()=>{b.setGlsl(a),a.setUniform("time",e.value)}),p.value=()=>{a.setBounds({xStart:-2,xEnd:2,yStart:-2,yEnd:2})}}),S("pointerup",v),(a,o)=>(x(),d(I,null,{options:s(()=>[i(L,{label:"Equation:"},{default:s(()=>[i(N,{modelValue:n.value,"onUpdate:modelValue":o[0]||(o[0]=g=>n.value=g)},null,8,["modelValue"]),m.value?(x(),d(h,{key:0,style:{"white-space":"pre"},onClick:m.value},{default:s(()=>[U]),_:1},8,["onClick"])):C("",!0)]),_:1}),i($,{sliders:T(b)},null,8,["sliders"])]),buttons:s(()=>[p.value?(x(),d(h,{key:0,onClick:p.value},{default:s(()=>[X]),_:1},8,["onClick"])):C("",!0)]),indicator:s(()=>[i(R,{style:{width:"100%","align-items":"center"}},{default:s(()=>[_("progress",{ref_key:"progress",ref:r,class:"progress",value:e.value,max:"1",onPointerdown:v,onPointermove:v,onTouchmove:B},null,40,j),_("span",{class:"play",onClick:o[1]||(o[1]=g=>e.value===1?E():w())},"\u25B6")]),_:1})]),default:s(()=>[_("canvas",{ref_key:"canvas",ref:f},null,512)]),_:1}))}});var re=D(G,[["__scopeId","data-v-4ca0406c"]]);export{re as default};
