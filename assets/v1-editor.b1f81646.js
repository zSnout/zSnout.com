...
"""
${e.code}
""").run()`)}}),(u,h)=>(X(),Y(Me,{field:$(a),"onUpdate:field":h[0]||(h[0]=m=>Z(a)?a.value=m:null),messages:$(o),"onUpdate:messages":h[1]||(h[1]=m=>Z(o)?o.value=m:null),placeholder:$(p),onKey:$(i),onSelect:$(s),onSubmit:$(d)},null,8,["field","messages","placeholder","onKey","onSelect","onSubmit"]))}});const _r=J({__name:"v1-editor",setup(r){const e=De(`@global $money = 500
@global $eggs = 0
@global $name = (no name)
$eggprice = 6
