import{u as A}from"./index.e47cf3d6.js";import{B as T,_ as D}from"./VStack.a77958dd.js";import{u as R,_ as ee}from"./ColorSliders.a5931819.js";import{d as V,o as m,f as B,a as l,t as M,F as te,c as h,w as u,m as le,p as H,g as G,b as s,e as w,s as p,a9 as K,aL as oe,u as P,aH as E,q as y}from"./index.4027b45f.js";import{D as ae}from"./Dropdown.988ec753.js";import{H as ne,F as ie}from"./SharedNav.2801f695.js";import{F as se}from"./FullscreenDisplay.5e087dc5.js";import{I as re}from"./InlineField.1a1cf53e.js";import{I as z}from"./InlineCheckboxField.486dd1e4.js";import{L as g}from"./Labeled.2aa16b89.js";import{g as U}from"./useGlsl.e7d88fb3.js";import{s as v}from"./useOption.2591489b.js";import{M as ue}from"./MovableCanvas2d.83287b44.js";import{I as ce}from"./InlineRangeField.a0962479.js";import"./CoordinateCanvas2d.6b99bd80.js";import"./WebGlCanvas.968a1b37.js";const de=l("h1",null,"Color Sliders",-1),me=V({__name:"ColorSlidersHelp",props:{page:null,note:null},setup(o){return(c,f)=>(m(),B(te,null,[de,l("p",null,M(o.page)+" and many other pages on zSnout share the same set of sliders, so it's good to get used to them. The best way to understand the sliders is to play with them and experiment on various pages."+M(o.note&&` ${o.note}`),1)],64))}}),Z=V({__name:"IconButton",setup(o){return(c,f)=>(m(),h(T,{center:"",style:{width:"2.5em",height:"2.25em"}},{default:u(()=>[le(c.$slots,"default")]),_:3}))}});const fe={},pe=o=>(H("data-v-0298e8c4"),o=o(),G(),o),ve={class:"icon",viewBox:"0 0 485.064 485.064",xmlns:"http://www.w3.org/2000/svg"},he=pe(()=>l("path",{d:`M458.736,181.097H26.334C11.793,181.097,0,192.884,0,207.425v70.215c0,14.541,11.787,26.328,26.334,26.328h432.402\r
  ...
  `,S=p(),q=p(),b=p(),O=p(1);let i;const F=K({get(){return O.value},set(e){O.value=e,i==null||i.setPixelRatio(e)}});return oe(()=>{!S.value||(i=new ue(S.value,{fragmentString:N.replace("{{EQ}}",U(a.value)).replace("{{EQC}}",U(a.value.replace(/m/g,"c"))),saveBounds:!0}),v("resolution",F),S.value.addEventListener("contextmenu",e=>{var t;if(e.preventDefault(),a.value.includes("m")||a.value.includes("t")){const{x:n,y:X}=i.mouseToCoords();a.value=a.value.replace(/m/g,`$(${n}+${X}i)`).replace(/t/g,`@(${i.time})`)}else a.value.includes("$")||a.value.includes("@")?a.value=a.value.replace(/\$\s*\([^)]*\)/g,"m").replace(/@\s*\([^)]*\)/g,"t"):a.value.includes("c")?a.value=a.value.replace(/c/g,"m"):a.value=a.value+"+m";r.value!=="newton"&&!a.value.includes("m")&&(x.value=!0),(t=b.value)==null||t.call(b)}),b.value=()=>setTimeout(()=>i.load(N.replace("{{EQ}}",U(a.value)).replace("{{EQC}}",U(a.value.replace(/m/g,"c"))))),i.on("render",()=>{if(i.setUniform("detail",[c.value]),i.setUniform("limit",_.value),i.setUniformOfInt("theme",[J.value]),i.setUniformOfInt("darkness",[k.value]),i.setUniformOfInt("split",[r.value==="simple"&&a.value.includes("m")||C.value]),i.setUniformOfInt("altColors",[(r.value!=="simple"||a.value.includes("m"))&&I.value]),i.setUniformOfInt("initZ",[r.value==="newton"||a.value.includes("m")||x.value]),i.setUniformOfInt("dualPlot",[r.value!=="newton"&&a.value.includes("m")&&$.value]),L.setGlsl(i),a.value.includes("m")){const{x:e,y:t}=i.mouseToCoords();i.setUniform("z_offset",e,t)}else if(a.value.includes("$")){const e=a.value.match(/\$\s*\(\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)\s*\+\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)i\s*\)/);if(e){const t=+e[1],n=+e[2];i.setUniform("z_offset",Number.isFinite(t)?t:0,Number.isFinite(n)?n:0)}else i.setUniform("z_offset",0,0)}else i.setUniform("z_offset",0,0)}),q.value=()=>{i.setBounds({xStart:-2,xEnd:2,yStart:-2,yEnd:2})})}),(e,t)=>(m(),h(se,null,{options:u(()=>[s(Q,{modelValue:P(c),"onUpdate:modelValue":t[0]||(t[0]=n=>E(c)?c.value=n:null),decrement:f,increment:d,label:"Detail Level:"},null,8,["modelValue"]),s(Q,{modelValue:P(_),"onUpdate:modelValue":t[1]||(t[1]=n=>E(_)?_.value=n:null),decrement:j,increment:W,label:"Fractal Size:"},null,8,["modelValue"]),s(g,{label:"Equation:"},{default:u(()=>[s(ie,{modelValue:a.value,"onUpdate:modelValue":t[2]||(t[2]=n=>a.value=n)},null,8,["modelValue"]),b.value?(m(),h(T,{key:0,style:{"white-space":"pre"},onClick:b.value},{default:u(()=>[Se]),_:1},8,["onClick"])):y("",!0)]),_:1}),s(g,{label:"Theme:"},{default:u(()=>[s(ae,{modelValue:r.value,"onUpdate:modelValue":t[3]||(t[3]=n=>r.value=n)},{default:u(()=>[Fe,Pe,Ue,qe,Ee,Te]),_:1},8,["modelValue"])]),_:1}),s(ee,{sliders:P(L)},null,8,["sliders"]),s(g,{label:"Darkness Effect?"},{default:u(()=>[s(z,{modelValue:k.value,"onUpdate:modelValue":t[4]||(t[4]=n=>k.value=n)},null,8,["modelValue"])]),_:1}),r.value!=="newton"&&r.value!=="simple"?(m(),h(g,{key:0,label:r.value==="rotation"?"Alternate Split?":r.value==="trig"?"Alternate Trig Functions?":r.value==="exp"?"Invert Exponentials?":"Split Effect?"},{default:u(()=>[s(z,{modelValue:C.value,"onUpdate:modelValue":t[5]||(t[5]=n=>C.value=n)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),r.value==="newton"||r.value==="trig"||r.value==="exp"?(m(),h(g,{key:1,label:r.value==="newton"?"3D Effect?":"Alternate Coloring?"},{default:u(()=>[s(z,{modelValue:I.value,"onUpdate:modelValue":t[6]||(t[6]=n=>I.value=n)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),r.value!=="newton"&&!a.value.includes("m")?(m(),h(g,{key:2,label:"Initialize Z?"},{default:u(()=>[s(z,{modelValue:x.value,"onUpdate:modelValue":t[7]||(t[7]=n=>x.value=n)},null,8,["modelValue"])]),_:1})):y("",!0),r.value==="newton"||a.value.includes("m")?(m(),h(g,{key:3,label:"Dual Coloring?"},{default:u(()=>[s(z,{modelValue:$.value,"onUpdate:modelValue":t[8]||(t[8]=n=>$.value=n)},null,8,["modelValue"])]),_:1})):y("",!0),s(g,{label:"Resolution:"},{default:u(()=>[s(ce,{modelValue:P(F),"onUpdate:modelValue":t[9]||(t[9]=n=>E(F)?F.value=n:null),min:.1,max:1,step:"any"},null,8,["modelValue","min"])]),_:1})]),buttons:u(()=>[q.value?(m(),h(T,{key:0,onClick:q.value},{default:u(()=>[Me]),_:1},8,["onClick"])):y("",!0)]),help:u(()=>[De,Be,Le,Ne,Oe,Ae,Re,Ke,Ze,Qe,He,Ge,je,We,Ye,s(me,{page:"Fractal Explorer",note:`Note that
    "Grayscale" and "Overcoloring" only have effects in themes with gray colors
    ("Gradient", "Trigonometric", and "Exponential").`}),Je,Xe,et]),default:u(()=>[l("canvas",{ref_key:"canvas",ref:S},null,512)]),_:1}))}});export{_t as default};
