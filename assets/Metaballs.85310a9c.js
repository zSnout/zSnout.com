import{F as i}from"./FullscreenDisplay.01d2b06a.js";import{W as f}from"./WebGlCanvas.260ee414.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.a72ff2fb.js";import"./BookmarkIcon.701950e0.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
