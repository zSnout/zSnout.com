import{F as d}from"./FullscreenDisplay.caa8f0d9.js";import{W as f}from"./WebGlCanvas.d5a10803.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.c0079452.js";import"./SharedNav.8fabc7b7.js";import"./VStack.9958415f.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
