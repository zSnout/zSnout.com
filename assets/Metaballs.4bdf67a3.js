import{F as d}from"./FullscreenDisplay.b5d9daed.js";import{W as f}from"./WebGlCanvas.c0d48ea0.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.2691e7b8.js";import"./BookmarkIcon.2d870479.js";import"./VStack.b4498dae.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
