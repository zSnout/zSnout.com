...
@eggs
  ...
  @elseif $money = $eggprice
    ...
    $eggs += $egg
  @else
    You don't have enough money for these eggs!`);return(s,u)=>(h(),_(E,null,{default:U(()=>[f(F,{modelValue:r(i),"onUpdate:modelValue":u[0]||(u[0]=g=>d(i)?i.value=g:null),round:""},null,8,["modelValue"]),f(Y,{code:r(i)},null,8,["code"])]),_:1}))}});export{M as default};
