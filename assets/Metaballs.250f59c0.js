import{F as i}from"./FullscreenDisplay.f9aa6b99.js";import{W as f}from"./WebGlCanvas.dbd117b3.js";import{d as x,k as y,B as m,c as g,w as p,o as u,a as h}from"./index.d3b89921.js";import"./Modal.e15c17d4.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
