import{F as i}from"./FullscreenDisplay.7a2d1c8c.js";import{W as f}from"./WebGlCanvas.3b7c9a3c.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.15748092.js";import"./BookmarkIcon.fd3553c6.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
