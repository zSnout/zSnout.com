import{u as q}from"./index.204a8aaa.js";import{B as F,_ as U}from"./VStack.23a9f6eb.js";import{u as E,_ as j}from"./ColorSliders.29a6d7e6.js";import{D as J}from"./Dropdown.3d395e52.js";import{H as W,F as X}from"./BookmarkIcon.8da08d84.js";import{F as Y}from"./FullscreenDisplay.17bb050f.js";import{d as w,o as d,c as p,w as s,n as Z,f as K,p as T,g as O,a as m,b as r,e as P,t as ee,k as v,a9 as te,aL as le,u as I,aH as B,m as V}from"./index.23592886.js";import{I as oe}from"./InlineField.bba90ab2.js";import{I as $}from"./InlineCheckboxField.250130e8.js";import{L as x}from"./Labeled.5d3dfe55.js";import{g as D}from"./useGlsl.eb35910b.js";import{s as _}from"./useOption.8f9fd735.js";import{M as ae}from"./MovableCanvas2d.124bca3e.js";import"./InlineRangeField.90ea313b.js";import"./CoordinateCanvas2d.de09f682.js";import"./WebGlCanvas.98cacfd1.js";const L=w({__name:"IconButton",setup(t){return(i,c)=>(d(),p(F,{center:"",style:{width:"2.5em",height:"2.25em"}},{default:s(()=>[Z(i.$slots,"default")]),_:3}))}});const ne={},re=t=>(T("data-v-0298e8c4"),t=t(),O(),t),se={class:"icon",viewBox:"0 0 485.064 485.064",xmlns:"http://www.w3.org/2000/svg"},ie=re(()=>m("path",{d:`M458.736,181.097H26.334C11.793,181.097,0,192.884,0,207.425v70.215c0,14.541,11.787,26.328,26.334,26.328h432.402\r
  ...
  `,h=v(),k=v(),b=v();return le(()=>{if(!h.value)return;const e=new ae(h.value,{fragmentString:M.replace("{{EQ}}",D(a.value)),saveBounds:!0});h.value.addEventListener("contextmenu",l=>{var o;if(l.preventDefault(),a.value.includes("m")){const{x:C,y:G}=e.mouseToCoords();a.value=a.value.replace(/m/g,`$(${C}+${G}i)`)}else a.value.includes("$")?a.value=a.value.replace(/\$\s*\([^)]*\)/g,"m"):a.value.includes("c")?(a.value=a.value.replace(/c/g,"m"),n.value==="simple"&&(g.value=!0)):(a.value=a.value+"+m",n.value==="simple"&&(g.value=!0));(o=b.value)==null||o.call(b)}),b.value=()=>{e.load(M.replace("{{EQ}}",D(a.value)))},e.on("render",()=>{if(e.setUniform("detail",[i.value]),e.setUniform("limit",f.value),e.setUniformOfInt("theme",[Q.value]),e.setUniformOfInt("darkness",[z.value]),e.setUniformOfInt("split",[g.value]),e.setUniformOfInt("altColors",[y.value]),S.setGlsl(e),a.value.includes("m")){const{x:l,y:o}=e.mouseToCoords();e.setUniform("z_offset",l,o)}else if(a.value.includes("$")){const l=a.value.match(/\$\s*\(\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)\s*\+\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)i\s*\)/);if(l){const o=+l[1],C=+l[2];e.setUniform("z_offset",Number.isFinite(o)?o:0,Number.isFinite(C)?C:0)}else e.setUniform("z_offset",0,0)}else e.setUniform("z_offset",0,0)}),k.value=()=>{e.setBounds({xStart:-2,xEnd:2,yStart:-2,yEnd:2})}}),(e,l)=>(d(),p(Y,null,{options:s(()=>[r(N,{modelValue:I(i),"onUpdate:modelValue":l[0]||(l[0]=o=>B(i)?i.value=o:null),decrement:c,increment:u,label:"Detail Level:"},null,8,["modelValue"]),r(N,{modelValue:I(f),"onUpdate:modelValue":l[1]||(l[1]=o=>B(f)?f.value=o:null),decrement:A,increment:H,label:"Fractal Size:"},null,8,["modelValue"]),r(x,{label:"Equation:"},{default:s(()=>[r(X,{modelValue:a.value,"onUpdate:modelValue":l[2]||(l[2]=o=>a.value=o)},null,8,["modelValue"]),b.value?(d(),p(F,{key:0,style:{"white-space":"pre"},onClick:b.value},{default:s(()=>[ye]),_:1},8,["onClick"])):V("",!0)]),_:1}),r(x,{label:"Theme:"},{default:s(()=>[r(J,{modelValue:n.value,"onUpdate:modelValue":l[3]||(l[3]=o=>n.value=o)},{default:s(()=>[he,Ce,Ve,we,ke,Ie]),_:1},8,["modelValue"])]),_:1}),r(j,{sliders:I(S)},null,8,["sliders"]),r(x,{label:"Darkness Effect?"},{default:s(()=>[r($,{modelValue:z.value,"onUpdate:modelValue":l[4]||(l[4]=o=>z.value=o)},null,8,["modelValue"])]),_:1}),n.value!=="newton"?(d(),p(x,{key:0,label:n.value==="simple"?"Mimic Newton's Method?":n.value==="rotation"?"Alternate Split?":n.value==="trig"?"Alternate Trig Functions?":n.value==="exp"?"Invert Exponentials?":"Split Effect?"},{default:s(()=>[r($,{modelValue:g.value,"onUpdate:modelValue":l[5]||(l[5]=o=>g.value=o)},null,8,["modelValue"])]),_:1},8,["label"])):V("",!0),n.value==="newton"||n.value==="trig"||n.value==="exp"||n.value==="simple"?(d(),p(x,{key:1,label:n.value==="newton"?"3D Effect?":n.value==="simple"?"Reverse Coloring?":"Alternate Coloring?"},{default:s(()=>[r($,{modelValue:y.value,"onUpdate:modelValue":l[6]||(l[6]=o=>y.value=o)},null,8,["modelValue"])]),_:1},8,["label"])):V("",!0)]),buttons:s(()=>[k.value?(d(),p(F,{key:0,onClick:k.value},{default:s(()=>[$e]),_:1},8,["onClick"])):V("",!0)]),default:s(()=>[m("canvas",{ref_key:"canvas",ref:h},null,512)]),_:1}))}});export{Re as default};
