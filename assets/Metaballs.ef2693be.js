import{F as d}from"./FullscreenDisplay.1be57afb.js";import{W as f}from"./WebGlCanvas.90b32b51.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.a8171189.js";import"./SharedNav.48cd01f2.js";import"./VStack.3d6ae560.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
