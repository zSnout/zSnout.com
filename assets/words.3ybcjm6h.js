...
kolo:
  category: content
  examples:
    - [kolo kato., The cat's color.]
    - [wilo se kolo kato., The cat's color is green.]
  translation: color
...
pali:
  ...
  notes:
    This verb requires more than two arguments. If it only has one _a_ clause,
    it is implied whether it is the thing to be given or the person the thing is
    given to.
  translation: to give
...
tan:
  category: [content, relative]
  notes:
    _tan_ may also be used in its prefix form of ta- before another word
    describing a relative.
  similar: [man, pan]
