...
eggs
  ...
  @elseif $money = $eggprice
    ...
    $eggs += $egg
  @else
    You don't have enough money for these eggs!`);return(r,a)=>(Y(),X(je,null,{default:De(()=>[oe(Ze,{modelValue:$(e),"onUpdate:modelValue":a[0]||(a[0]=o=>Z(e)?e.value=o:null),round:""},null,8,["modelValue"]),oe(vt,{code:$(e)},null,8,["code"])]),_:1}))}});export{At as default};
