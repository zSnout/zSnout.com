var V=Object.defineProperty,O=Object.defineProperties;var K=Object.getOwnPropertyDescriptors;var w=Object.getOwnPropertySymbols;var U=Object.prototype.hasOwnProperty,W=Object.prototype.propertyIsEnumerable;var h=(s,e,o)=>e in s?V(s,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):s[e]=o,p=(s,e)=>{for(var o in e||(e={}))U.call(e,o)&&h(s,o,e[o]);if(w)for(var o of w(e))W.call(e,o)&&h(s,o,e[o]);return s},m=(s,e)=>O(s,K(e));import{u as $,E as z}from"./useLocationHash.ab8cc651.js";import{d as b,_ as A}from"./index.f70abdcf.js";import{u as B,C as N}from"./Console.7939f673.js";import{d as _,E as Y,aK as F,ad as H,o as k,c as v,u as i,x as c,w as L,b as x}from"./index.09ff9e18.js";import"./DocumentDisplay.36b6708d.js";import"./Modal.9c2abee5.js";import"./AceEditor.8fee77b4.js";import"./_commonjsHelpers.294d03c4.js";import"./__vite-browser-external.2d3e1c2d.js";import"./Dropdown.fc9f804c.js";import"./Field.fe9ca36f.js";import"./Labeled.a4e0e086.js";const R=_({__name:"Viewer4",props:{code:null},setup(s){const e=s,{console:o,field:r,messages:u,onKey:j,onSelect:C,onSubmit:E,placeholder:d}=B(),S=Object.getPrototypeOf(async function(){}).constructor;function f(){o.clear(),d.value="",Object.assign(window,o),Object.assign(window,{print:o.log,jsx(g,t,...a){if(typeof g=="string"){let l=document.createElement(g);for(let n in t)if(n==="style")for(let y in t.style)l.style[y]=t.style[y];else n.startsWith("data")?l.dataset[n.slice(4)]=t[n]:n.startsWith("on")?l.addEventListener(n.slice(2,3).toUpperCase()+n.slice(3),t[n]):l[n]=t[n];for(let n of a.flat(1/0))n instanceof Node||typeof n=="string"?l.append(n):l.append(""+n);return l}try{return new g(a.length?m(p({},t),{children:a}):t)}catch{return g(a.length?m(p({},t),{children:a}):t)}}}),new S(b.transpile(b.compile(e.code),{jsx:"jsx",target:99}))()}return f(),Y(H(e,"code"),F(f,1e3)),(g,t)=>(k(),v(N,{field:i(r),"onUpdate:field":t[0]||(t[0]=a=>c(r)?r.value=a:null),messages:i(u),"onUpdate:messages":t[1]||(t[1]=a=>c(u)?u.value=a:null),placeholder:i(d),onKey:i(j),onSelect:i(C),onSubmit:i(E)},null,8,["field","messages","placeholder","onKey","onSelect","onSubmit"]))}}),te=_({__name:"v4-editor",setup(s){const e=$(`money = 500
eggs = 0
...
await market()`);return(o,r)=>(k(),v(z,null,{default:L(()=>[x(A,{modelValue:i(e),"onUpdate:modelValue":r[0]||(r[0]=u=>c(e)?e.value=u:null),round:""},null,8,["modelValue"]),x(R,{code:i(e),round:""},null,8,["code"])]),_:1}))}});export{te as default};
