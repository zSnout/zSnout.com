import{F as d}from"./FullscreenDisplay.980c9a14.js";import{W as f}from"./WebGlCanvas.ab3958d8.js";import{d as x,s as y,aG as m,o as g,c as p,w as u,a as h}from"./index.3457413b.js";import"./SharedNav.720d082d.js";import"./VStack.d9a6c01a.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
