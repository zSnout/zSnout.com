import{q as a,L as z,d as b,o as g,h as w,b as r,w as v,u as t,M as n,F as V}from"./index.w2xoota4.js";import{s as c}from"./useOption.ujvp9hcq.js";import{I as i}from"./InlineRangeField.4poaov81.js";import{L as m}from"./Labeled.29mn7ohi.js";function _(){const o=a(0);c("colorOffset",o);const u=a(0);c("grayscale",u);const e=a(1);c("repetition",e);const x=a(0);c("noise",x);const f=a(0);c("separation",f);const d=a(1);c("spectrum",d);const p=a(0);c("overcolor",p);const h=a(Math.random()*1e4);return z(()=>h.value+=.01),{colorOffset:o,grayscale:u,noiseLevel:x,overcolor:p,repetition:e,separation:f,spectrum:d,time:h,setGlsl:U}}(o=>{function u(e){return`
