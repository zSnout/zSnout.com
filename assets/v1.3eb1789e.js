...
`).filter(function(e){return!!e.match(ae)&&!e.match(/^Error created at/)},this).map(function(e){var t,a=e.split("@"),o=this.extractLocation(a.pop()),i=a.shift()||"",s=i.replace(/<anonymous function(: (\w+))?>/,"$2").replace(/\([^)]*\)/g,"")||void 0;i.match(/\(([^)]*)\)/)&&(t=i.replace(/^[^(]+\(([^)]*)\)$/,"$1"));var d=t===void 0||t==="[arguments not available]"?void 0:t.split(",");return new T({functionName:s,args:d,fileName:o[0],lineNumber:o[1],columnNumber:o[2],source:e})},this)}});let n={noImageDecoding:!0,noAudioDecoding:!0,noWasmDecoding:!1,preloadedWasm:{},preRun:[]},l={};n.API=l;let h={};n.hiwire=h;let Q={};function qe(r,e,t){e&&(n.print=e),t&&(n.printErr=t),r&&n.preRun.push(function(){n.FS.init(function(a){const o=new TextEncoder;let i=new Uint8Array(0),s=-1;function d(){try{if(s===-1){let p=a();if(p==null)return null;if(typeof p!="string")throw new TypeError(`Expected stdin to return string, null, or undefined, got type ${typeof p}.`);p.endsWith(`
`)||(p+=`
`),i=o.encode(p),s=0}if(s<i.length){let p=i[s];return s++,p}return s=-1,null}catch(p){throw console.error("Error thrown in stdin:"),console.error(p),p}}return d}(r),null,null)})}l.tests=Q;const S=typeof process!="undefined"&&process.release&&process.release.name==="node"&&process.browser===void 0;let me,H,_e,R,V,N;if(V=S?function(r,e){return w(this,void 0,void 0,function*(){if(e.startsWith("file://")&&(e=e.slice(7)),e.includes("://")){let t=yield H(e);if(!t.ok)throw new Error(`Failed to load '${e}': request failed.`);return yield t.arrayBuffer()}{const t=yield R.readFile(`${r}${e}`);return new Uint8Array(t.buffer,t.byteOffset,t.byteLength)}})}:function(r,e){return w(this,void 0,void 0,function*(){const t=new URL(r,location),a=new URL(e,t);let o=yield fetch(a);if(!o.ok)throw new Error(`Failed to load '${a}': request failed.`);return new Uint8Array(yield o.arrayBuffer())})},globalThis.document)N=r=>w(void 0,void 0,void 0,function*(){return yield x(()=>import(r),[])});else if(globalThis.importScripts)N=r=>w(void 0,void 0,void 0,function*(){try{globalThis.importScripts(r)}catch(e){if(!(e instanceof TypeError))throw e;yield x(()=>import(r),[])}});else{if(!S)throw new Error("Cannot determine runtime environment");N=function(r){return w(this,void 0,void 0,function*(){r.startsWith("file://")&&(r=r.slice(7)),r.includes("://")?_e.runInThisContext(yield(yield H(r)).text()):yield x(()=>import(me.resolve(r)),[])})}}function ee(r){return!!r&&r.$$!==void 0&&r.$$.type==="PyProxy"}l.isPyProxy=ee,globalThis.FinalizationRegistry?n.finalizationRegistry=new FinalizationRegistry(([r,e])=>{e.leaked=!0,ge(e);try{n._Py_DecRef(r)}catch(t){l.fatal_error(t)}}):n.finalizationRegistry={register(){},unregister(){}};let D,K,B=new Map;function v(r){let e=r.$$.ptr;if(e===0)throw new Error(r.$$.destroyed_msg);return e}n.pyproxy_alloc_map=B,n.enable_pyproxy_allocation_tracing=function(){D=function(r){B.set(r,Error().stack)},K=function(r){B.delete(r)}},n.disable_pyproxy_allocation_tracing=function(){D=function(r){},K=function(r){}},n.disable_pyproxy_allocation_tracing(),n.pyproxy_new=function(r,e){let t,a=n._pyproxy_getflags(r),o=n.getPyProxyClass(a);256&a?(t=Reflect.construct(Function,[],o),delete t.length,delete t.name,t.prototype=void 0):t=Object.create(o.prototype),!e&&(e={cacheId:h.new_value(new Map),refcnt:0}),e.refcnt++,Object.defineProperty(t,"$$",{value:{ptr:r,type:"PyProxy",cache:e}}),n._Py_IncRef(r);let i=new Proxy(t,Je);return D(i),n.finalizationRegistry.register(i,[r,e],i),i};let se=new Map;n.getPyProxyClass=function(r){const e=[[1,Ue],[2,Ze],[4,He],[8,Ke],[16,We],[32,Ge],[64,Xe],[128,Qe],[256,ve]];let t=se.get(r);if(t)return t;let a={};for(let[s,d]of e)r&s&&Object.assign(a,Object.getOwnPropertyDescriptors(d.prototype));a.constructor=Object.getOwnPropertyDescriptor(le.prototype,"constructor"),Object.assign(a,Object.getOwnPropertyDescriptors({$$flags:r}));let o=Object.create(le.prototype,a);function i(){}return i.prototype=o,se.set(r,i),i},n.PyProxy_getPtr=v;function ge(r){if(r&&(r.refcnt--,r.refcnt===0)){let e=h.pop_value(r.cacheId);for(let t of e.values()){const a=h.pop_value(t);r.leaked||n.pyproxy_destroy(a,"This borrowed attribute proxy was automatically destroyed in the process of destroying the proxy it was borrowed from. Try using the 'copy' method.")}}}n.pyproxy_destroy=function(r,e){if(r.$$.ptr===0)return;let t=v(r);n.finalizationRegistry.unregister(r),e=e||"Object has already been destroyed";let a,o=r.type;try{a=r.toString()}catch(i){if(i.pyodide_fatal_error)throw i}r.$$.ptr=0,e+=`
The object was of type "${o}" and `,e+=a?`had repr "${a}"`:"an error was raised when trying to generate its repr",r.$$.destroyed_msg=e,ge(r.$$.cache);try{n._Py_DecRef(t),K(r)}catch(i){l.fatal_error(i)}},n.callPyObjectKwargs=function(r,...e){let t=e.pop(),a=e.length,o=Object.keys(t),i=Object.values(t),s=o.length;e.push(...i);let d,p=h.new_value(e),c=h.new_value(o);try{d=n.__pyproxy_apply(r,p,a,c,s)}catch(y){l.fatal_error(y)}finally{h.decref(p),h.decref(c)}d===0&&n._pythonexc2js();let u=h.pop_value(d);return u&&u.type==="coroutine"&&u._ensure_future&&u._ensure_future(),u},n.callPyObject=function(r,...e){return n.callPyObjectKwargs(r,...e,{})};class le{constructor(){throw new TypeError("PyProxy is not a constructor")}get[Symbol.toStringTag](){return"PyProxy"}get type(){let e=v(this);return h.pop_value(n.__pyproxy_type(e))}toString(){let e,t=v(this);try{e=n.__pyproxy_repr(t)}catch(a){l.fatal_error(a)}return e===0&&n._pythonexc2js(),h.pop_value(e)}destroy(e){n.pyproxy_destroy(this,e)}copy(){let e=v(this);return n.pyproxy_new(e,this.$$.cache)}toJs({depth:e=-1,pyproxies:t,create_pyproxies:a=!0,dict_converter:o,default_converter:i}={}){let s,d,p=v(this),c=0,u=0;d=a?t?h.new_value(t):h.new_value([]):0,o&&(c=h.new_value(o)),i&&(u=h.new_value(i));try{s=n._python2js_custom(p,e,d,c,u)}catch(y){l.fatal_error(y)}finally{h.decref(d),h.decref(c),h.decref(u)}return s===0&&n._pythonexc2js(),h.pop_value(s)}supportsLength(){return!!(1&this.$$flags)}supportsGet(){return!!(2&this.$$flags)}supportsSet(){return!!(4&this.$$flags)}supportsHas(){return!!(8&this.$$flags)}isIterable(){return!!(48&this.$$flags)}isIterator(){return!!(32&this.$$flags)}isAwaitable(){return!!(64&this.$$flags)}isBuffer(){return!!(128&this.$$flags)}isCallable(){return!!(256&this.$$flags)}}class Ue{get length(){let e,t=v(this);try{e=n._PyObject_Size(t)}catch(a){l.fatal_error(a)}return e===-1&&n._pythonexc2js(),e}}class Ze{get(e){let t,a=v(this),o=h.new_value(e);try{t=n.__pyproxy_getitem(a,o)}catch(i){l.fatal_error(i)}finally{h.decref(o)}if(t===0){if(!n._PyErr_Occurred())return;n._pythonexc2js()}return h.pop_value(t)}}class He{set(e,t){let a,o=v(this),i=h.new_value(e),s=h.new_value(t);try{a=n.__pyproxy_setitem(o,i,s)}catch(d){l.fatal_error(d)}finally{h.decref(i),h.decref(s)}a===-1&&n._pythonexc2js()}delete(e){let t,a=v(this),o=h.new_value(e);try{t=n.__pyproxy_delitem(a,o)}catch(i){l.fatal_error(i)}finally{h.decref(o)}t===-1&&n._pythonexc2js()}}class Ke{has(e){let t,a=v(this),o=h.new_value(e);try{t=n.__pyproxy_contains(a,o)}catch(i){l.fatal_error(i)}finally{h.decref(o)}return t===-1&&n._pythonexc2js(),t===1}}class We{[Symbol.iterator](){let e,t=v(this),a={};try{e=n._PyObject_GetIter(t)}catch(i){l.fatal_error(i)}e===0&&n._pythonexc2js();let o=function*(i,s){try{let d;for(;d=n.__pyproxy_iter_next(i);)yield h.pop_value(d)}catch(d){l.fatal_error(d)}finally{n.finalizationRegistry.unregister(s),n._Py_DecRef(i)}n._PyErr_Occurred()&&n._pythonexc2js()}(e,a);return n.finalizationRegistry.register(o,[e,void 0],a),o}}class Ge{[Symbol.iterator](){return this}next(e){let t,a,o=h.new_value(e),i=n.stackSave(),s=n.stackAlloc(4);try{t=n.__pyproxyGen_Send(v(this),o,s)}catch(p){l.fatal_error(p)}finally{h.decref(o)}let d=n.HEAPU32[0+(s>>2)];return n.stackRestore(i),t===-1&&n._pythonexc2js(),a=t===0,{done:a,value:h.pop_value(d)}}}let Je={isExtensible:()=>!0,has:(r,e)=>!!Reflect.has(r,e)||typeof e!="symbol"&&(e.startsWith("$")&&(e=e.slice(1)),function(t,a){let o,i=v(t),s=h.new_value(a);try{o=n.__pyproxy_hasattr(i,s)}catch(d){l.fatal_error(d)}finally{h.decref(s)}return o===-1&&n._pythonexc2js(),o!==0}(r,e)),get(r,e){if(e in r||typeof e=="symbol")return Reflect.get(r,e);e.startsWith("$")&&(e=e.slice(1));let t=function(a,o){let i,s=v(a),d=h.new_value(o),p=a.$$.cache.cacheId;try{i=n.__pyproxy_getattr(s,d,p)}catch(c){l.fatal_error(c)}finally{h.decref(d)}return i===0&&n._PyErr_Occurred()&&n._pythonexc2js(),i}(r,e);return t!==0?h.pop_value(t):void 0},set(r,e,t){let a=Object.getOwnPropertyDescriptor(r,e);if(a&&!a.writable)throw new TypeError(`Cannot set read only field '${e}'`);return typeof e=="symbol"?Reflect.set(r,e,t):(e.startsWith("$")&&(e=e.slice(1)),function(o,i,s){let d,p=v(o),c=h.new_value(i),u=h.new_value(s);try{d=n.__pyproxy_setattr(p,c,u)}catch(y){l.fatal_error(y)}finally{h.decref(c),h.decref(u)}d===-1&&n._pythonexc2js()}(r,e,t),!0)},deleteProperty(r,e){let t=Object.getOwnPropertyDescriptor(r,e);if(t&&!t.writable)throw new TypeError(`Cannot delete read only field '${e}'`);return typeof e=="symbol"?Reflect.deleteProperty(r,e):(e.startsWith("$")&&(e=e.slice(1)),function(a,o){let i,s=v(a),d=h.new_value(o);try{i=n.__pyproxy_delattr(s,d)}catch(p){l.fatal_error(p)}finally{h.decref(d)}i===-1&&n._pythonexc2js()}(r,e),!t||!!t.configurable)},ownKeys(r){let e,t=v(r);try{e=n.__pyproxy_ownKeys(t)}catch(o){l.fatal_error(o)}e===0&&n._pythonexc2js();let a=h.pop_value(e);return a.push(...Reflect.ownKeys(r)),a},apply:(r,e,t)=>r.apply(e,t)};class Xe{_ensure_future(){if(this.$$.promise)return this.$$.promise;let e,t,a,o=v(this),i=new Promise((p,c)=>{e=p,t=c}),s=h.new_value(e),d=h.new_value(t);try{a=n.__pyproxy_ensure_future(o,s,d)}catch(p){l.fatal_error(p)}finally{h.decref(d),h.decref(s)}return a===-1&&n._pythonexc2js(),this.$$.promise=i,this.destroy(),i}then(e,t){return this._ensure_future().then(e,t)}catch(e){return this._ensure_future().catch(e)}finally(e){return this._ensure_future().finally(e)}}class ve{apply(e,t){return n.callPyObject(v(this),...t)}call(e,...t){return n.callPyObject(v(this),...t)}callKwargs(...e){if(e.length===0)throw new TypeError("callKwargs requires at least one argument (the key word argument object)");let t=e[e.length-1];if(t.constructor!==void 0&&t.constructor.name!=="Object")throw new TypeError("kwargs argument is not an object");return n.callPyObjectKwargs(v(this),...e)}}ve.prototype.prototype=Function.prototype;let W,we,Ye=new Map([["i8",Int8Array],["u8",Uint8Array],["u8clamped",Uint8ClampedArray],["i16",Int16Array],["u16",Uint16Array],["i32",Int32Array],["u32",Uint32Array],["i32",Int32Array],["u32",Uint32Array],["i64",globalThis.BigInt64Array],["u64",globalThis.BigUint64Array],["f32",Float32Array],["f64",Float64Array],["dataview",DataView]]);class Qe{getBuffer(e){let t;if(e&&(t=Ye.get(e),t===void 0))throw new Error(`Unknown type ${e}`);let a,o=n.HEAPU32,i=n.stackSave(),s=n.stackAlloc(o[0+(n._buffer_struct_size>>2)]),d=v(this);try{a=n.__pyproxy_get_buffer(s,d)}catch(P){l.fatal_error(P)}a===-1&&n._pythonexc2js();let p=o[0+(s>>2)],c=o[1+(s>>2)],u=o[2+(s>>2)],y=!!o[3+(s>>2)],m=o[4+(s>>2)],f=o[5+(s>>2)],_=h.pop_value(o[6+(s>>2)]),g=h.pop_value(o[7+(s>>2)]),k=o[8+(s>>2)],z=!!o[9+(s>>2)],O=!!o[10+(s>>2)],A=n.UTF8ToString(m);n.stackRestore(i);let F=!1;try{let P=!1;t===void 0&&([t,P]=n.processBufferFormatString(A," In this case, you can pass an explicit type argument."));let b=parseInt(t.name.replace(/[^0-9]/g,""))/8||1;if(P&&b>1)throw new Error("Javascript has no native support for big endian buffers. In this case, you can pass an explicit type argument. For instance, `getBuffer('dataview')` will return a `DataView`which has native support for reading big endian data. Alternatively, toJs will automatically convert the buffer to little endian.");let I=u-c;if(I!==0&&(p%b!=0||c%b!=0||u%b!=0))throw new Error(`Buffer does not have valid alignment for a ${t.name}`);let te,Fe=I/b,Ie=(p-c)/b;te=I===0?new t:new t(o.buffer,c,Fe);for(let Ne of g.keys())g[Ne]/=b;return F=!0,Object.create(xe.prototype,Object.getOwnPropertyDescriptors({offset:Ie,readonly:y,format:A,itemsize:f,ndim:_.length,nbytes:I,shape:_,strides:g,data:te,c_contiguous:z,f_contiguous:O,_view_ptr:k,_released:!1}))}finally{if(!F)try{n._PyBuffer_Release(k),n._PyMem_Free(k)}catch(P){l.fatal_error(P)}}}}class xe{constructor(){throw new TypeError("PyBuffer is not a constructor")}release(){if(!this._released){try{n._PyBuffer_Release(this._view_ptr),n._PyMem_Free(this._view_ptr)}catch(e){l.fatal_error(e)}this._released=!0,this.data=null}}}const er=/^.*?([^\/]*)\.whl$/;function rr(r){let e=er.exec(r);if(e)return e[1].toLowerCase().split("-").slice(0,-4).join("-")}function be(r,e,t){if(r=r.toLowerCase(),e.has(r))return;const a=l.packages[r];if(!a)throw new Error(`No known package with name '${r}'`);if(a.shared_library?t.set(r,"default channel"):e.set(r,"default channel"),E[r]===void 0)for(let o of a.depends)be(o,e,t)}function ce(r,e){return w(this,void 0,void 0,function*(){let t;if(e==="default channel"){if(!(r in l.packages))throw new Error(`Internal error: no entry for package named ${r}`);t=l.packages[r].file_name}else t=e;try{return yield V(W,t)}catch(o){if(!S)throw o}let a=yield V(we,t);return yield R.writeFile(`${W}${t}`,a),a})}function ue(r,e){return w(this,void 0,void 0,function*(){let t=l.packages[r];t||(t={file_name:".whl",install_dir:"site",shared_library:!1,depends:[],imports:[]});const a=t.file_name,o=l.package_loader.unpack_buffer.callKwargs({buffer:e,filename:a,target:t.install_dir,calculate_dynlibs:!0});for(const i of o)yield Pe(i,t.shared_library);E[r]=t})}function ke(){let r=Promise.resolve();return function(){return w(this,void 0,void 0,function*(){const e=r;let t;return r=new Promise(a=>t=a),yield e,t})}}const tr=ke();function Pe(r,e){return w(this,void 0,void 0,function*(){let t;t=n.FS.lookupPath(r).node.mount.type==n.FS.filesystems.MEMFS?n.FS.filesystems.MEMFS.getFileDataAsTypedArray(n.FS.lookupPath(r).node):n.FS.readFile(r);const a=yield tr();try{const o=yield n.loadWebAssemblyModule(t,{loadAsync:!0,nodelete:!0,allowUndefined:!0});n.preloadedWasm[r]=o,n.preloadedWasm[r.split("/").pop()]=o,e&&n.loadDynamicLibrary(r,{global:!0,nodelete:!0})}catch(o){if(o.message.includes("need to see wasm magic number"))return void console.warn(`Failed to load dynlib ${r}. We probably just tried to load a linux .so file or something.`);throw o}finally{a()}})}Q.loadDynlib=Pe;const nr=ke();function re(r,e,t){return w(this,void 0,void 0,function*(){e=e||console.log,t=t||console.error,ee(r)&&(r=r.toJs()),Array.isArray(r)||(r=[r]);const[a,o]=function(d,p){const c=new Map,u=new Map;for(let y of d){const m=rr(y);m!==void 0?c.has(m)&&c.get(m)!==y?p(`Loading same package ${m} from ${y} and ${c.get(m)}`):c.set(m,y):be(y,c,u)}return[c,u]}(r,t);for(const[d,p]of[...a,...o]){const c=E[d];c!==void 0&&(a.delete(d),o.delete(d),c===p||p==="default channel"?e(`${d} already loaded from ${c}`):t(`URI mismatch, attempting to load package ${d} from ${p} while it is already loaded from ${c}. To override a dependency, load the custom package first.`))}if(a.size===0&&o.size===0)return void e("No new packages to load");const i=[...a.keys(),...o.keys()].join(", "),s=yield nr();try{e(`Loading ${i}`);const d={},p={};for(const[f,_]of o)E[f]?o.delete(f):d[f]=ce(f,_);for(const[f,_]of a)E[f]?a.delete(f):p[f]=ce(f,_);const c=[],u={},y={},m={};for(const[f,_]of o)y[f]=d[f].then(g=>w(this,void 0,void 0,function*(){yield ue(f,g),c.push(f),E[f]=_})).catch(g=>{console.warn(g),u[f]=g});yield Promise.all(Object.values(y));for(const[f,_]of a)m[f]=p[f].then(g=>w(this,void 0,void 0,function*(){yield ue(f,g),c.push(f),E[f]=_})).catch(g=>{console.warn(g),u[f]=g});if(yield Promise.all(Object.values(m)),n.reportUndefinedSymbols(),c.length>0){const f=c.join(", ");e(`Loaded ${f}`)}if(Object.keys(u).length>0){const f=Object.keys(u).join(", ");e(`Failed to load ${f}`);for(const[_,g]of Object.entries(u))console.warn(`The following error occurred while loading ${_}:`),console.error(g)}l.importlib.invalidate_caches()}finally{s()}})}let E={};function $e(r){if(typeof r=="string")r=new Error(r);else if(typeof r!="object"||r===null||typeof r.stack!="string"||typeof r.message!="string"){let e=`A value of type ${typeof r} with tag ${Object.prototype.toString.call(r)} was thrown as an error!`;try{e+=`
...
del importlib
    `);if(n._PyRun_SimpleString(m))throw new Error("OOPS!");n._free(m),n.FS.unlink("/pyodide_py.tar")}(yield o),n._pyodide_init();let p=yr(t);var c;return p.version.includes("dev")||(c=`https://pyodide-cdn2.iodide.io/${p.version}/full/`,we=c),yield a,t.fullStdLib&&(yield re(["distutils"])),p.runPython("print('Python initialization complete')"),p})}l.saveState=()=>l.pyodide_py._state.save_state(),l.restoreState=r=>l.pyodide_py._state.restore_state(r),l.runPythonInternal=function(r){return l._pyodide._base.eval_code(r,Oe)};var hr=`import re
...
class story:
  ...
  def test(self,condition):
    ...
    return o
`;const mr=J({__name:"Viewer1",props:{code:null},setup(r){const e=r,{console:t,field:a,messages:o,onKey:i,onSelect:s,onSubmit:d,placeholder:p}=Ce(),c=G({stderr:t.error,stdout:t.log,indexURL:"https://cdn.jsdelivr.net/pyodide/v0.20.0/full/"});return Le({title:"Execute",onEnter:!0,async action(){t.clear(),p.value="";const u=await c;u.globals.set("code",e.code),Object.assign(window,{async prompt(y,m){return t.prompt(y,m)},wait(y=1){return new Promise(m=>{setTimeout(m,y*1e3)})}}),u.globals.set("prompt",async(y,m)=>t.prompt(y,m)),u.globals.set("wait",(y=1)=>new Promise(m=>{setTimeout(m,y*1e3)})),u.runPythonAsync(hr+`
await story(code).run()`)}}),(u,y)=>(Y(),X(Me,{field:$(a),"onUpdate:field":y[0]||(y[0]=m=>Z(a)?a.value=m:null),messages:$(o),"onUpdate:messages":y[1]||(y[1]=m=>Z(o)?o.value=m:null),placeholder:$(p),onKey:$(i),onSelect:$(s),onSubmit:$(d)},null,8,["field","messages","placeholder","onKey","onSelect","onSubmit"]))}});const _r=J({__name:"v1",setup(r){const e=De();return(t,a)=>(Y(),X(Re,{center:"","explicit-height":"","max-width":""},{default:oe(()=>[C(je,{class:"stack",space:.75,style:{height:"100%","justify-content":"center"}},{default:oe(()=>[C(Be,{modelValue:$(e),"onUpdate:modelValue":a[0]||(a[0]=o=>Z(e)?e.value=o:null),round:"",style:{flex:"1","max-width":"800px"}},null,8,["modelValue"]),C(mr,{class:"viewer",code:$(e)},null,8,["code"])]),_:1},8,["space"])]),_:1}))}});var $r=Ve(_r,[["__scopeId","data-v-0a1776f8"]]);export{$r as default};
