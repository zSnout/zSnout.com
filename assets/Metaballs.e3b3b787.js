import{F as i}from"./FullscreenDisplay.74612107.js";import{W as f}from"./WebGlCanvas.c2f6061c.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.7e4c8589.js";import"./BookmarkIcon.1c8612a0.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
