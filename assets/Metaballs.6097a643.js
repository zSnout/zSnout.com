import{F as i}from"./FullscreenDisplay.340041a3.js";import{W as f}from"./WebGlCanvas.40dd46c9.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.e8a5d947.js";import"./BookmarkIcon.274dcaf8.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
