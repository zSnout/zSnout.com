import{F as d}from"./FullscreenDisplay.9a388f22.js";import{W as f}from"./WebGlCanvas.16e66b54.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.c653be01.js";import"./SharedNav.cbddc32d.js";import"./VStack.eb3d5a98.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
