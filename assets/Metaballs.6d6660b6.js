import{F as d}from"./FullscreenDisplay.7762b611.js";import{W as f}from"./WebGlCanvas.9859e775.js";import{d as x,s as y,aG as m,o as g,c as p,w as u,a as h}from"./index.60732d6f.js";import"./SharedNav.064fa836.js";import"./VStack.503e3c99.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
