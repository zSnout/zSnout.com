import{d as z,o as b,f as g,b as r,w as v,u as t,aH as n,F as w,k as a,aF as V}from"./index.1496218b.js";import{s as c}from"./useOption.49b935cd.js";import{I as i}from"./InlineRangeField.e46a4b28.js";import{L as m}from"./Labeled.92edccc4.js";function _(){const o=a(0);c("colorOffset",o);const u=a(0);c("grayscale",u);const e=a(1);c("repetition",e);const x=a(0);c("noise",x);const f=a(0);c("separation",f);const d=a(1);c("spectrum",d);const p=a(0);c("overcolor",p);const h=a(Math.random()*1e4);return V(()=>h.value+=.01),{colorOffset:o,grayscale:u,noiseLevel:x,overcolor:p,repetition:e,separation:f,spectrum:d,time:h,setGlsl:U}}(o=>{function u(e){return`
