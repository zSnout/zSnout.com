import{F as d}from"./FullscreenDisplay.d9c17611.js";import{W as f}from"./WebGlCanvas.03ef9e8a.js";import{d as x,s as y,aM as m,o as g,c as p,w as u,a as h}from"./index.9880f5b0.js";import"./SharedNav.54163aaf.js";import"./VStack.04124f92.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
