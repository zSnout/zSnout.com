import{F as i}from"./FullscreenDisplay.45f0d05e.js";import{W as f}from"./WebGlCanvas.35e41cd9.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.2fa8603f.js";import"./BookmarkIcon.5097b963.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
