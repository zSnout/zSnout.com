import{F as d}from"./FullscreenDisplay.de0ed3d0.js";import{W as f}from"./WebGlCanvas.55c1ba96.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.6fd38de8.js";import"./BookmarkIcon.8dca6511.js";import"./VStack.0099a460.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
