...
await market()`);return(p,a)=>(h(),_(C,null,{default:U(()=>[y(S,{modelValue:n(s),"onUpdate:modelValue":a[0]||(a[0]=r=>u(s)?s.value=r:null),round:""},null,8,["modelValue"]),y(W,{code:n(s),round:""},null,8,["code"])]),_:1}))}});export{T as default};
