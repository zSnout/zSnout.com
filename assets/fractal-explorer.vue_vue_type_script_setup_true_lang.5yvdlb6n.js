import{d as B,o as v,h as H,a as o,t as A,F as J,q as c,g as X,Y as ee,C as te,c as h,w as s,e as i,u as U,M as O,b as F,i as y}from"./index.3ew7bob1.js";import{u as K}from"./index.55wflef3.js";import{B as Z}from"./VStack.xad5wxbj.js";import{u as L,_ as le}from"./ColorSliders.vue_vue_type_script_setup_true_lang.55nmm5y1.js";import{D as ae}from"./Dropdown.5andrccq.js";import{F as oe}from"./Field.2ydu2jt8.js";import{F as ne}from"./FullscreenDisplay.hao6npqe.js";import{I as N}from"./Incrementable.44806nyw.js";import{I as C}from"./InlineCheckboxField.67ybze61.js";import{L as p}from"./Labeled.29mn7ohi.js";import{g as E}from"./useGlsl.3n3wviqe.js";import{s as f}from"./useOption.ujvp9hcq.js";import{M as ie}from"./MovableCanvas2d.41imxryi.js";import{I as se}from"./InlineRangeField.4poaov81.js";const re=o("h1",null,"Color Sliders",-1),ue=B({__name:"ColorSlidersHelp",props:{page:null,note:null},setup(_){return(P,r)=>(v(),H(J,null,[re,o("p",null,A(_.page)+" and many other pages on zSnout share the same set of sliders, so it's good to get used to them. The best way to understand the sliders is to play with them and experiment on various pages."+A(_.note&&` ${_.note}`),1)],64))}}),ce=o("option",{value:"simple"},"Simple",-1),de=o("option",{value:"gradient"},"Gradient",-1),fe=o("option",{value:"rotation"},"Rotation",-1),me=o("option",{value:"trig"},"Trigonometric",-1),pe=o("option",{value:"exp"},"Exponential",-1),ve=o("option",{value:"newton"},"Newton's Method",-1),he=o("h1",null,"Moving the Explorer",-1),ge=o("p",null," On mobile, move the image using one finger and pinch to zoom using two fingers. ",-1),be=o("p",null," On desktop, click and drag using a mouse or trackpad to move the image and scroll using a mouse or pinch on a trackpad using two fingers to zoom. ",-1),xe=o("h1",null,"Adjusting Detail",-1),ye=o("p",null,' If you zoom in for a while, the fractal will start to have flat edges. To combat this, increase the "Detail Level." Increasing it makes your computer slower and uses more battery, so adjust this carefully. ',-1),_e=o("h1",null,"Fractal Size",-1),ze=o("p",null,' If you see sharp cutoffs at the edges of a fractal, try increasing the "Fractal Size" to see more of the image. Alternatively, shrink the value to crop certain parts of your fractal. ',-1),we=o("h1",null,"The Equation",-1),ke=o("p",null,[F(' When creating a fractal, try putting interesting equations into the "Equation" field. The Z and C variables are standard in fractals. Check out '),o("a",{href:"https://www.youtube.com/watch?v=FFftmWSzgmk&ab_channel=Numberphile",target:"_blank"}," this video behind the Mandelbrot Set "),F(" for more information. Additionally, zSnout provides M (the current mouse position), P (also the mouse position), T (the time that the page has been loaded for), and e, i, and pi. You may use the +, -, *, /, and ^ operators. ")],-1),Ce=o("p",null,' Setting a new equation requires modifying several aspects of a program, so it will not be automatically applied unless you select the "Apply" button. ',-1),Ie=o("p",null," If you have an equation with M and/or T, right-click the canvas to replace the M and T variables with their values. ",-1),Ve=o("h1",null,"Choosing a Theme",-1),Te=o("p",null,` The Fractal Explorer has six different color themes. You may select one via a dropdown. When using an equation without C or M (e.g. z - (z^3 - 1) / 3z^2), it is recommended to use "Newton's Method" or check "Initialize Z". `,-1),qe=o("p",null,' If your equation has M, "Initialize Z" will automatically be checked and hidden. This does not apply to P. ',-1),Ue=o("h1",null,"Theme Checkboxes",-1),Ee=o("p",null," At the bottom of the options page, you will find two to three checkboxes. These are specific to each theme. You may select or deselect any of these to produce unique results for each theme. The best way to understand what they do is to play around with them and learn by doing, not reading. ",-1),Fe=o("h1",null,"Quick Actions",-1),Pe=o("p",null," Right-clicking the canvas modifies your equation. It will primarily swap M and T for your current mouse position and time, while leaving P unaffected. If the current equation does not contain M or T, right-clicking will swap all instances of C for M. ",-1),Me=o("p",null,' Double clicking will toggle "Dual Coloring" or "Initialize Z," depending on which one is currently shown. ',-1),Se=o("p",null,"The left and right arrow keys swap through the various themes.",-1),De=o("p",null,"The up and down arrows adjust the detail level.",-1),$e=o("p",null,"The R button resets the position of your fractal.",-1),Je=B({__name:"fractal-explorer",props:{noSave:{type:Boolean}},setup(_){const{noSave:P}=_,r=!P,d=K(100,5,1e3);r&&f("detail",d);function M(e){return e<=10?5:e<=25?5*Math.ceil((e-5)/5):e<=50?25:50*Math.ceil((e-50)/50)}function S(e){return e<10?10:e<25?5*~~((e+5)/5):e<50?50:50*~~((e+50)/50)}const z=K(2,.1,1/0);r&&f("limit",z);function R(e){return e<=2?(Math.ceil(10*e)-1)/10:Math.ceil(e-1)}function Q(e){return e<2?(~~(10*e)+1)/10:~~(e+1)}const t=c("z^2+c");r&&f("equation",t);const n=c("simple");r&&f("theme",n);const j={simple:1,gradient:2,rotation:3,newton:4,trig:5,exp:6},G=X(()=>j[n.value]),D=L({save:r}),I=c(0);r&&f("minIter",I);const V=c(!1);r&&f("darkness",V);const T=c(!1);r&&f("split",T);const q=c(!1);r&&f("altColors",q);const m=c(!1);r&&f("initZ",m);const g=c(!1);r&&f("dualPlot",g);const $=`
  ...
  `,w=c(),b=c(),x=c();return ee(()=>{if(!w.value)return;const e=new ie(w.value,{fragmentString:$.replace("{{EQ}}",E(t.value)).replace("{{EQC}}",E(t.value.replace(/m|p/g,"c"))),saveBounds:r}),a=["simple","gradient","rotation","trig","exp","newton"];te("keydown",l=>{var u;if(l.target===document.body&&!l.ctrlKey&&!l.altKey&&!l.metaKey)switch(l.preventDefault(),l.key){case"ArrowLeft":n.value=a[(a.indexOf(n.value)-1+a.length)%a.length];break;case"ArrowRight":n.value=a[(a.indexOf(n.value)+1)%a.length];break;case"ArrowUp":d.value=S(d.value);break;case"ArrowDown":d.value=M(d.value);break;case"R":case"r":(u=b.value)==null||u.call(b);break}}),w.value.addEventListener("dblclick",l=>{l.preventDefault(),n.value!=="newton"&&!t.value.includes("m")?m.value=!m.value:t.value.includes("m")&&(g.value=!g.value)}),w.value.addEventListener("contextmenu",l=>{var k;l.preventDefault();let u=!0;if(t.value.includes("m")||t.value.includes("p")||t.value.includes("t")){t.value.includes("p")&&(u=!1);const{x:Y,y:W}=e.mouseToCoords();t.value=t.value.replace(/m|p/g,`$(${Y}+${W}i)`).replace(/t/g,`@(${e.time})`)}else t.value.includes("$")||t.value.includes("@")?m.value?t.value=t.value.replace(/\$\s*\([^)]*\)/g,"m").replace(/@\s*\([^)]*\)/g,"t"):(t.value=t.value.replace(/\$\s*\([^)]*\)/g,"p").replace(/@\s*\([^)]*\)/g,"t"),u=!1):t.value.includes("c")?t.value=t.value.replace(/c/g,"m"):t.value=t.value+"+m";n.value!=="newton"&&!t.value.includes("m")&&(m.value=u),(k=x.value)==null||k.call(x)}),x.value=()=>setTimeout(()=>e.load($.replace("{{EQ}}",E(t.value)).replace("{{EQC}}",E(t.value.replace(/m/g,"c"))))),e.on("render",()=>{if(e.setUniform("detail",[d.value]),e.setUniform("limit",z.value),e.setUniformOfInt("theme",[G.value]),e.setUniformOfInt("darkness",[V.value]),e.setUniform("minIter",I.value),e.setUniformOfInt("split",[n.value==="simple"&&t.value.includes("m")||T.value]),e.setUniformOfInt("altColors",[(n.value!=="simple"||t.value.includes("m"))&&q.value]),e.setUniformOfInt("initZ",[n.value==="newton"||t.value.includes("m")||m.value]),e.setUniformOfInt("dualPlot",[(t.value.includes("m")||t.value.includes("p"))&&g.value]),D.setGlsl(e),t.value.includes("m")){const{x:l,y:u}=e.mouseToCoords();e.setUniform("z_offset",l,u)}else if(t.value.includes("$")){const l=t.value.match(/\$\s*\(\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)\s*\+\s*(-?\d+(?:\.\d+)?(?:e[+-]?\d+)?)i\s*\)/);if(l){const u=+l[1],k=+l[2];e.setUniform("z_offset",Number.isFinite(u)?u:0,Number.isFinite(k)?k:0)}else e.setUniform("z_offset",0,0)}else e.setUniform("z_offset",0,0)}),b.value=()=>{e.setBounds({xStart:-2,xEnd:2,yStart:-2,yEnd:2})}}),(e,a)=>(v(),h(ne,null,{options:s(()=>[i(N,{modelValue:U(d),"onUpdate:modelValue":a[0]||(a[0]=l=>O(d)?d.value=l:null),decrement:M,increment:S,label:"Detail Level:"},null,8,["modelValue"]),i(N,{modelValue:U(z),"onUpdate:modelValue":a[1]||(a[1]=l=>O(z)?z.value=l:null),decrement:R,increment:Q,label:"Fractal Size:"},null,8,["modelValue"]),i(p,{label:"Equation:"},{default:s(()=>[i(oe,{modelValue:t.value,"onUpdate:modelValue":a[2]||(a[2]=l=>t.value=l)},null,8,["modelValue"]),x.value?(v(),h(Z,{key:0,style:{"white-space":"pre"},onClick:x.value},{default:s(()=>[F(" Apply ")]),_:1},8,["onClick"])):y("",!0)]),_:1}),i(p,{label:"Theme:"},{default:s(()=>[i(ae,{modelValue:n.value,"onUpdate:modelValue":a[3]||(a[3]=l=>n.value=l)},{default:s(()=>[ce,de,fe,me,pe,ve]),_:1},8,["modelValue"])]),_:1}),i(le,{sliders:U(D)},null,8,["sliders"]),i(p,{label:"Darkness Effect?"},{default:s(()=>[i(C,{modelValue:V.value,"onUpdate:modelValue":a[4]||(a[4]=l=>V.value=l)},null,8,["modelValue"])]),_:1}),n.value!=="newton"&&n.value!=="simple"?(v(),h(p,{key:0,label:n.value==="rotation"?"Alternate Split?":n.value==="trig"?"Alternate Trig Functions?":n.value==="exp"?"Invert Exponentials?":"Split Effect?"},{default:s(()=>[i(C,{modelValue:T.value,"onUpdate:modelValue":a[5]||(a[5]=l=>T.value=l)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),n.value==="newton"||n.value==="trig"||n.value==="exp"?(v(),h(p,{key:1,label:n.value==="newton"?"3D Effect?":"Alternate Coloring?"},{default:s(()=>[i(C,{modelValue:q.value,"onUpdate:modelValue":a[6]||(a[6]=l=>q.value=l)},null,8,["modelValue"])]),_:1},8,["label"])):y("",!0),n.value!=="newton"&&!t.value.includes("m")?(v(),h(p,{key:2,label:"Initialize Z?"},{default:s(()=>[i(C,{modelValue:m.value,"onUpdate:modelValue":a[7]||(a[7]=l=>m.value=l)},null,8,["modelValue"])]),_:1})):y("",!0),t.value.includes("m")||t.value.includes("p")?(v(),h(p,{key:3,label:"Dual Coloring?"},{default:s(()=>[i(C,{modelValue:g.value,"onUpdate:modelValue":a[8]||(a[8]=l=>g.value=l)},null,8,["modelValue"])]),_:1})):y("",!0),i(p,{label:"Minimum Iterations"},{default:s(()=>[i(se,{modelValue:I.value,"onUpdate:modelValue":a[9]||(a[9]=l=>I.value=l),max:U(d),min:0},null,8,["modelValue","max"])]),_:1})]),buttons:s(()=>[b.value?(v(),h(Z,{key:0,onClick:b.value},{default:s(()=>[F(" Reset Position ")]),_:1},8,["onClick"])):y("",!0)]),help:s(()=>[he,ge,be,xe,ye,_e,ze,we,ke,Ce,Ie,Ve,Te,qe,Ue,Ee,i(ue,{note:`Note that
    "Grayscale" and "Overcoloring" only have effects in themes with gray colors
    ("Gradient", "Trigonometric", and "Exponential").`,page:"Fractal Explorer"}),Fe,Pe,Me,Se,De,$e]),default:s(()=>[o("canvas",{ref_key:"canvas",ref:w},null,512)]),_:1}))}});export{Je as _};
