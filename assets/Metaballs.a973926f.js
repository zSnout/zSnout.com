import{F as d}from"./FullscreenDisplay.a9e7c405.js";import{W as f}from"./WebGlCanvas.c19ba351.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.106f3036.js";import"./SharedNav.e5c5befd.js";import"./VStack.f6c7e851.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
