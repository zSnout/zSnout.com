import{d as z,o as b,h as g,b as r,w as v,F as w,m as a,aF as V,u as t,aH as n}from"./index.9d51cee5.js";import{s as c}from"./useOption.db6d066d.js";import{I as i}from"./InlineRangeField.0b156467.js";import{L as m}from"./Labeled.749825ff.js";function _(){const o=a(0);c("colorOffset",o);const u=a(0);c("grayscale",u);const e=a(1);c("repetition",e);const x=a(0);c("noise",x);const f=a(0);c("separation",f);const d=a(1);c("spectrum",d);const p=a(0);c("overcolor",p);const h=a(Math.random()*1e4);return V(()=>h.value+=.01),{colorOffset:o,grayscale:u,noiseLevel:x,overcolor:p,repetition:e,separation:f,spectrum:d,time:h,setGlsl:U}}(o=>{function u(e){return`
