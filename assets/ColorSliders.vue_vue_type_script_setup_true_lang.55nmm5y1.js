import{q as t,L as z,d as g,o as b,h as w,e as r,w as a,u as v,M as n,F as V}from"./index.3ew7bob1.js";import{s as c}from"./useOption.ujvp9hcq.js";import{I as i}from"./InlineRangeField.4poaov81.js";import{L as m}from"./Labeled.29mn7ohi.js";function _({save:e=!0}={}){const u=t(0);e&&c("colorOffset",u);const o=t(0);e&&c("grayscale",o);const x=t(1);e&&c("repetition",x);const f=t(0);e&&c("noise",f);const d=t(0);e&&c("separation",d);const p=t(1);e&&c("spectrum",p);const h=t(0);e&&c("overcolor",h);const y=t(Math.random()*1e4);return z(()=>y.value+=.01),{colorOffset:u,grayscale:o,noiseLevel:f,overcolor:h,repetition:x,separation:d,spectrum:p,time:y,setGlsl:U}}(e=>{function u(o){return`
