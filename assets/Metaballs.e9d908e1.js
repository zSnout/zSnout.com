import{F as d}from"./FullscreenDisplay.5e087dc5.js";import{W as f}from"./WebGlCanvas.968a1b37.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.4027b45f.js";import"./SharedNav.2801f695.js";import"./VStack.a77958dd.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
