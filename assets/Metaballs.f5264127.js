import{F as d}from"./FullscreenDisplay.52474f66.js";import{W as f}from"./WebGlCanvas.75c51362.js";import{d as x,k as y,aL as m,o as g,c as p,w as u,a as h}from"./index.d8290167.js";import"./BookmarkIcon.b15b703d.js";import"./VStack.4f9c2f5c.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
