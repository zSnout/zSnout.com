...
@eggs
  ...
  @elseif $money = $eggprice
    ...
    $eggs += $egg
  @else
    You don't have enough money for these eggs!`);return(t,g)=>(y(),R(B,{"dual-editor":""},{default:S(()=>[_(w,{modelValue:$(d),"onUpdate:modelValue":g[0]||(g[0]=k=>F(d)?d.value=k:null),round:""},null,8,["modelValue"]),_(j,{code:$(d),round:""},null,8,["code"])]),_:1}))}});export{N as default};
