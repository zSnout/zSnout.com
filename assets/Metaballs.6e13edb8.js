import{F as i}from"./FullscreenDisplay.0d2b3156.js";import{W as f}from"./WebGlCanvas.c1441923.js";import{d as x,k as y,G as m,o as g,c as p,w as u,a as h}from"./index.482d59cd.js";import"./BookmarkIcon.f6cdedeb.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
