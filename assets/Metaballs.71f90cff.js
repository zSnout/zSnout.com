import{F as d}from"./FullscreenDisplay.2a7ae4cd.js";import{W as f}from"./WebGlCanvas.e9ad0b8c.js";import{d as x,s as y,aL as m,o as g,c as p,w as u,a as h}from"./index.80e7fb4e.js";import"./SharedNav.c43960c8.js";import"./VStack.ae3d12ba.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
