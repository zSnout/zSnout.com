import{F as d}from"./FullscreenDisplay.e4ced142.js";import{W as f}from"./WebGlCanvas.a21875db.js";import{d as x,s as y,aO as m,o as g,c as p,w as u,a as h}from"./index.e9cc25ec.js";import"./SharedNav.57e661d0.js";import"./VStack.7090fa40.js";const k=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
