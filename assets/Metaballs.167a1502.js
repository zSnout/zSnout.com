import{F as i}from"./FullscreenDisplay.046aaa21.js";import{W as f}from"./WebGlCanvas.164c6e07.js";import{d as x,k as y,I as m,c as g,w as p,o as u,a as h}from"./index.a54ee94c.js";import"./BookmarkIcon.740bc2ca.js";const w=x({__name:"Metaballs",setup(v){const e=Array.from({length:50},()=>{const t=Math.random(),o=Math.random(),r=Math.random()*5+5,a=(Math.random()-.5)*2/200,s=(Math.random()-.5)*2/200;return{x:t,y:o,r,dx:a,dy:s}}),n=y(),l=`
  uniform float scale;
